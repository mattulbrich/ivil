...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Operators.dll
...
{
  var x: int where InRange(x, System.Int32), y: int where InRange(y, System.Int32), c: bool where true, a: ref where $IsNotNull(a, RefArray(System.Object, 1)), stack0i: int, stack0b: bool, b: bool where true, stack1b: bool, stack1i: int, return.value: bool where true, SS$Display.Return.Local: bool where true;

  entry:
    assume $IsNotNull(this, Operators);
  ...
  block4403:
    // ----- nop
    // ----- copy  ----- Operators.ssc(13,5)
    stack0i := x;
    // ----- unary operator  ----- Operators.ssc(13,5)
    stack0i := 0 - stack0i;
    // ----- binary operator  ----- Operators.ssc(13,5)
    // ----- branch  ----- Operators.ssc(13,5)
    goto true4403to4437, false4403to4420;
  ...
  block4454:
    ...
    // ----- copy
    stack0b := c;
    // ----- binary operator  ----- Operators.ssc(14,5)
    // ----- branch  ----- Operators.ssc(14,5)
  ...
  block4556:
    // ----- copy
    b := stack0b;
    // ----- binary operator  ----- Operators.ssc(15,5)
    stack0i := #or(x, y);
    // ----- load constant 0  ----- Operators.ssc(15,5)
    stack1i := 0;
    // ----- binary operator  ----- Operators.ssc(15,5)
    // ----- branch  ----- Operators.ssc(15,5)
    goto true4556to4590, false4556to4573;
  ...
  block4607:
    ...
    // ----- copy
    b := stack0b;
    // ----- binary operator  ----- Operators.ssc(16,5)
    stack0i := #and(x, y);
    // ----- load constant 0  ----- Operators.ssc(16,5)
    stack1i := 0;
    // ----- binary operator  ----- Operators.ssc(16,5)
    // ----- branch  ----- Operators.ssc(16,5)
  ...
  block4658:
    ...
    // ----- copy
    b := stack0b;
    // ----- binary operator  ----- Operators.ssc(17,5)
    stack0i := #xor(x, y);
    // ----- binary operator  ----- Operators.ssc(17,5)
    // ----- branch  ----- Operators.ssc(17,5)
  ...
  block4709:
    // ----- copy
    b := stack0b;
    // ----- binary operator  ----- Operators.ssc(21,5)
    stack0i := #shl(x, y);
    // ----- load constant 6  ----- Operators.ssc(21,5)
    stack1i := 6;
    // ----- binary operator  ----- Operators.ssc(21,5)
    // ----- branch  ----- Operators.ssc(21,5)
    goto true4709to4794, false4709to4726;
  ...
  block4811:
    // ----- copy
    b := stack0b;
    // ----- array length  ----- Operators.ssc(22,5)
    assert a != null;
    stack0i := $Length(a);
    // ----- load constant 12  ----- Operators.ssc(22,5)
    stack1i := 12;
    // ----- binary operator  ----- Operators.ssc(22,5)
    // ----- branch  ----- Operators.ssc(22,5)
    goto true4811to4845, false4811to4828;
...
{
  var b: bool where true, c: bool where true, return.value: bool where true, SS$Display.Return.Local: bool where true, stack0b: bool;
  ...
  block6579:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- Operators.ssc(30,3)
    stack0b := return.value;
    // ----- return  ----- Operators.ssc(30,3)
    $result := stack0b;
    return;
...
implementation Operators..ctor(this: ref)
{
  ...
  block6817:
    // ----- call  ----- Operators.ssc(1,14)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Operators ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Operators;
    assume IsHeap($Heap);
    return;
