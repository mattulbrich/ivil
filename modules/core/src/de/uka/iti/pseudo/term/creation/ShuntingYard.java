...
public final class ShuntingYard {
    ...
    /*
     * Hide the default constructor, this has only static methods.
     */
     ...
     */
    public static @NonNull  ASTTerm shuntingYard(@NonNull Environment env,
            @NonNull ASTListTerm listTerm) throws ASTVisitException {
        ...
        for (ASTTerm element : listTerm.getSubterms()) {
            ...
            if(expectOperator) {
                if(element instanceof ASTOperatorIdentifierTerm) {
                    ...
                    throw new ASTVisitException("We expected an operator but received " +
                            element, element);
                }
