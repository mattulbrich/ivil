...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo WhileGood
...
{
  var n: int where InRange(n, System.Int32), m: int where InRange(m, System.Int32), i: int where InRange(i, System.Int32), stack0o: ref, stack0b: bool, local3825: int where InRange(local3825, System.Int32), stack0i: int, return.value: int where InRange(return.value, System.Int32), local3842: int where InRange(local3842, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32), $Heap$block3077$LoopPreheader: [ref,<x>name]x;
  ...
  block3043:
    // ----- load constant 0  ----- WhileGood.ssc(6,9)
    m := 0;
    goto block3060;

  block3060:
    // ----- load constant 0  ----- WhileGood.ssc(7,9)
    i := 0;
    goto block3077$LoopPreheader;

  block3077:
    // ----- default loop invariant: allocation and ownership are stable  ----- WhileGood.ssc(9,23)
    assume (forall $o: ref :: $Heap$block3077$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block3077$LoopPreheader[$ot, $allocated] == true && $Heap$block3077$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block3077$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block3077$LoopPreheader[$ot, $ownerFrame]) && $Heap$block3077$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- WhileGood.ssc(9,23)
    assume (forall $o: ref :: ($Heap$block3077$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block3077$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block3077$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block3077$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- WhileGood.ssc(9,23)
    assert (forall $o: ref :: $o != null && $Heap$block3077$LoopPreheader[$o, $allocated] == true ==> $Heap$block3077$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block3077$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- serialized LoopInvariant  ----- WhileGood.ssc(9,23)
    assert m == i;
    goto block3230;
  ...
  block3247:
    // ----- binary operator  ----- WhileGood.ssc(8,16)
    // ----- branch  ----- WhileGood.ssc(8,9)
    goto true3247to3349, false3247to3264;
  ...
  block3264:
    // ----- copy  ----- WhileGood.ssc(11,13)
    local3825 := m;
    // ----- load constant 1  ----- WhileGood.ssc(11,13)
    stack0i := 1;
    // ----- binary operator  ----- WhileGood.ssc(11,13)
  ...
  block3366:
    // ----- copy  ----- WhileGood.ssc(14,9)
    return.value := m;
    // ----- branch
    goto block3383;

  block3281:
    // ----- nop  ----- WhileGood.ssc(11,13)
    goto block3298;
  ...
  block3298:
    // ----- copy  ----- WhileGood.ssc(12,13)
    local3842 := i;
    // ----- load constant 1  ----- WhileGood.ssc(12,13)
    stack0i := 1;
    // ----- binary operator  ----- WhileGood.ssc(12,13)
    stack0i := local3842 + stack0i;
    // ----- copy  ----- WhileGood.ssc(12,13)
    i := stack0i;
    // ----- copy  ----- WhileGood.ssc(12,13)
    stack0i := local3842;
  ...
  block3315:
    // ----- nop  ----- WhileGood.ssc(12,13)
    goto block3332;

  block3604:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- WhileGood.ssc(15,5)
    stack0i := return.value;
    // ----- return  ----- WhileGood.ssc(15,5)
    $result := stack0i;
    return;

  block3332:
    // ----- branch  ----- WhileGood.ssc(13,10)
    goto block3077;

  block3077$LoopPreheader:
    $Heap$block3077$LoopPreheader := $Heap;
    goto block3077;
