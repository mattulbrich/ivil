...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleAssignments3.dll /infer:i
...
{
  var value: int where InRange(value, System.Int32), stack0i: int, stack0b: bool, x: int where InRange(x, System.Int32), y: int where InRange(y, System.Int32), stack0o: ref;

  entry:
    assume $IsNotNull(this, SimpleAssignments3);
  ...
  block1326:
    // ----- load constant 2  ----- SimpleAssignments3.ssc(10,3)
    stack0i := 2;
    // ----- binary operator  ----- SimpleAssignments3.ssc(10,3)
    // ----- branch  ----- SimpleAssignments3.ssc(10,3)
    goto true1326to1360, false1326to1343;

  true1326to1360:
    assume value <= stack0i;
    goto block1360;
  ...
  block1360:
    // ----- load constant -12  ----- SimpleAssignments3.ssc(13,4)
    x := -12;
    // ----- nop  ----- SimpleAssignments3.ssc(13,10)
    goto block1377;

  block1343:
    // ----- load constant -5  ----- SimpleAssignments3.ssc(11,4)
    x := -5;
    // ----- branch  ----- SimpleAssignments3.ssc(12,3)
    goto block1377;

  block1377:
    // ----- copy  ----- SimpleAssignments3.ssc(15,3)
    y := x;
    // ----- serialized AssertStatement  ----- SimpleAssignments3.ssc(17,3)
    assert -50 <= y && y <= -2;
    goto block1496;

  block1496:
    // ----- nop
    // ----- return  ----- SimpleAssignments3.ssc(18,2)
    return;
...
implementation SimpleAssignments3..ctor(this: ref)
{
  ...
  block1853:
    // ----- call  ----- SimpleAssignments3.ssc(3,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleAssignments3 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleAssignments3;
    assume IsHeap($Heap);
    return;
