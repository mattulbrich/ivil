...
problem
  $impl(seqDom(x as seq(int),i as int) as bool,$or($not(isPermN(x as seq(int)) as bool) as bool,seqDom(x as seq(int),seqGet(x as seq(int),i as int) as int) as bool) as bool) as bool
