...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker0
...
implementation Chunker.NextChunk(this: ref) returns ($result: ref)
{
  ...
  block2516:
    ...
    // ----- copy  ----- Chunker0.ssc(12,3)
    stack0o := return.value;
    // ----- return  ----- Chunker0.ssc(12,3)
    $result := stack0o;
    return;
...
{
  var source: ref where $Is(source, System.String), chunkSize: int where InRange(chunkSize, System.Int32), temp0: exposeVersionType, temp1: exposeVersionType, stack0i: int, temp2: exposeVersionType;
  ...
  entry:
    ...
    assume $Heap[this, Chunker.src] == null;
  ...
  block2924:
    // ----- call  ----- Chunker0.ssc(15,3)
    assert this != null;
    call System.Object..ctor(this);
    goto block2941;

  block2941:
    // ----- store field  ----- Chunker0.ssc(16,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker0.ssc(17,5)
    assert this != null;
    havoc temp1;
    $Heap[this, $exposeVersion] := temp1;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker0.ssc(18,9)
    stack0i := 0;
    // ----- store field  ----- Chunker0.ssc(18,5)
    assert this != null;
    havoc temp2;
