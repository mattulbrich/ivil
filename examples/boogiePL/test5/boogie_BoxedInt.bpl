...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo BoxedInt
...
{
  var x: int where InRange(x, System.Int32), stack0o: ref, o: ref where $Is(o, System.Object), stack0i: int, y: int where InRange(y, System.Int32);
  ...
  block3876:
    ...
    // ----- copy  ----- BoxedInt.ssc(7,5)
    o := stack0o;
    goto block3893;

  block3893:
    // ----- unbox  ----- BoxedInt.ssc(8,5)
    assert UnboxedType(o) == System.Int32;
    stack0i := cast(Unbox(o),int);
    // ----- load indirect  ----- BoxedInt.ssc(8,5)
    y := stack0i;
    goto block3910;

  block3910:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(9,5)
    assert y == 6;
    goto block4063;
...
implementation BoxedInt.N$System.Int32(x$in: int)
{
  ...
  block4607:
    ...
    assume $Heap[stack0o, $allocated] == true;
    assume ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc));
    // ----- copy  ----- BoxedInt.ssc(14,5)
    o := stack0o;
    goto block4624;

  block4624:
    // ----- unbox  ----- BoxedInt.ssc(15,5)
    assert UnboxedType(o) == System.Int32;
    stack0i := cast(Unbox(o),int);
    // ----- load indirect  ----- BoxedInt.ssc(15,5)
    y := stack0i;
    goto block4641;

  block4641:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(16,5)
    assert y == 6;
    goto block4794;
...
{
  var x: real where true, stack0o: ref, o: ref where $Is(o, System.Object), stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block5083:
    // ----- box  ----- BoxedInt.ssc(21,16)
    havoc stack0o;
    assume Box(x, stack0o) == stack0o;
    assume UnboxedType(stack0o) == System.Double;
    assume $IsNotNull(stack0o, System.Object);
    assume $Heap[stack0o, $allocated] == true;
    assume ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc));
    // ----- copy  ----- BoxedInt.ssc(21,5)
    o := stack0o;
    goto block5100;

  block5100:
    // ----- unbox  ----- BoxedInt.ssc(22,5)
    assert UnboxedType(o) == System.Int32;
    stack0i := cast(Unbox(o),int);
    // ----- load indirect  ----- BoxedInt.ssc(22,5)
  ...
  block5134:
    ...
    // ----- copy  ----- BoxedInt.ssc(23,3)
    stack0i := return.value;
    // ----- return  ----- BoxedInt.ssc(23,3)
    $result := stack0i;
    return;
...
{
  var o: ref where $Is(o, System.Object), stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block5814:
    // ----- unbox  ----- BoxedInt.ssc(28,5)
    assert UnboxedType(o) == System.Int32;
    stack0i := cast(Unbox(o),int);
    // ----- load indirect  ----- BoxedInt.ssc(28,5)
    return.value := stack0i;
    // ----- branch
    goto block5831;
...
{
  var x: int where InRange(x, System.Int32), stack0o: ref, o: ref where $Is(o, System.Object), stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block6477:
    ...
    assume $Heap[stack0o, $allocated] == true;
    assume ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc));
    // ----- copy  ----- BoxedInt.ssc(33,5)
    o := stack0o;
    goto block6494;

  block6494:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(34,5)
    assert UnboxedType(o) == System.Int32;
    goto block6647;
  ...
  block6664:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(35,5)
    assert $IsNotNull(o, System.Object);
    goto block6817;
  ...
  block6834:
    // ----- unbox  ----- BoxedInt.ssc(36,5)
    assert UnboxedType(o) == System.Int32;
    stack0i := cast(Unbox(o),int);
    // ----- load indirect  ----- BoxedInt.ssc(36,5)
    return.value := stack0i;
    // ----- branch
    goto block6851;
  ...
  block6868:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- BoxedInt.ssc(37,3)
    stack0i := return.value;
    // ----- return  ----- BoxedInt.ssc(37,3)
    $result := stack0i;
    return;
...
{
  var x: int where InRange(x, System.Int32), stack0o: ref, o: ref where $Is(o, System.Object), stack1o: ref, stack0b: bool, b: bool where true, stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block7582:
    ...
    assume $Heap[stack0o, $allocated] == true;
    assume ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc));
    // ----- copy  ----- BoxedInt.ssc(41,5)
    o := stack0o;
    goto block7599;

  block7599:
    // ----- is instance  ----- BoxedInt.ssc(42,14)
    stack0o := BoxTester(o, System.Int32);
    stack1o := null;
    // ----- binary operator  ----- BoxedInt.ssc(42,5)
    // ----- branch  ----- BoxedInt.ssc(42,5)
    goto true7599to7633, false7599to7616;
  ...
  block7616:
    // ----- load constant False  ----- BoxedInt.ssc(42,5)
    stack0b := false;
    // ----- branch  ----- BoxedInt.ssc(42,5)
    goto block7667;
  ...
  block7650:
    // ----- load constant True  ----- BoxedInt.ssc(42,5)
    stack0b := true;
    goto block7667;

  block7684:
    // ----- copy  ----- BoxedInt.ssc(42,5)
    b := stack0b;
    goto block7701;

  block7701:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(43,5)
    assert b;
    goto block7854;
  ...
  block7871:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(44,5)
    assert $IsNotNull(o, System.Object);
    goto block8024;
  ...
  block8041:
    // ----- unbox  ----- BoxedInt.ssc(45,5)
    assert UnboxedType(o) == System.Int32;
    stack0i := cast(Unbox(o),int);
    // ----- load indirect  ----- BoxedInt.ssc(45,5)
    return.value := stack0i;
    // ----- branch
    goto block8058;
  ...
  block8075:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- BoxedInt.ssc(46,3)
    stack0i := return.value;
    // ----- return  ----- BoxedInt.ssc(46,3)
    $result := stack0i;
    return;
...
{
  var x: int where InRange(x, System.Int32), stack0o: ref, b: bool where true;
  ...
  block9979:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(52,5)
    assert true;
    goto block10132;
  ...
  block10149:
    // ----- load constant True  ----- BoxedInt.ssc(53,5)
    b := true;
    goto block10166;

  block10166:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(54,5)
    assert b;
    goto block10319;
  ...
  block10336:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(56,5)
    assert true;
    goto block10557;
  ...
  block10574:
    // ----- load constant False  ----- BoxedInt.ssc(57,5)
    b := false;
    goto block10591;

  block10591:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(58,5)
    assert !b;
    goto block10829;
  ...
  block10846:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(60,5)
    assert true;
    goto block10999;
  ...
  block11016:
    // ----- load constant True  ----- BoxedInt.ssc(61,5)
    b := true;
    goto block11033;

  block11033:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(62,5)
    assert b;
    goto block11186;
  ...
  block11203:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(64,5)
    assert true;
    goto block11424;
  ...
  block11441:
    // ----- load constant False  ----- BoxedInt.ssc(65,5)
    b := false;
    goto block11458;

  block11458:
    // ----- serialized AssertStatement  ----- BoxedInt.ssc(66,5)
    assert !b;
    goto block11696;
...
{
  var stack0i: int, stack0o: ref, stack0r: real;
  ...
  block12716:
    // ----- load constant 6  ----- BoxedInt.ssc(70,13)
    stack0i := 6;
    // ----- call  ----- BoxedInt.ssc(70,11)
    call BoxedInt.M$System.Int32(stack0i);
    // ----- load constant "M(6) succeeded"  ----- BoxedInt.ssc(70,35)
    stack0o := $stringLiteral7;
    // ----- call  ----- BoxedInt.ssc(70,17)
  ...
  block12835:
    // ----- load constant 6  ----- BoxedInt.ssc(72,13)
    stack0i := 6;
    // ----- call  ----- BoxedInt.ssc(72,11)
    call BoxedInt.N$System.Int32(stack0i);
    // ----- load constant "N(6) succeeded"  ----- BoxedInt.ssc(72,35)
    stack0o := $stringLiteral8;
    // ----- call  ----- BoxedInt.ssc(72,17)
    call System.Console.WriteLine$System.String(stack0o);
    // ----- branch
    goto block12937;
  ...
  block12954:
    // ----- load constant 7  ----- BoxedInt.ssc(74,13)
    stack0i := 7;
    // ----- call  ----- BoxedInt.ssc(74,11)
    call BoxedInt.N$System.Int32(stack0i);
    // ----- load constant "N(7) succeeded"  ----- BoxedInt.ssc(74,35)
    stack0o := $stringLiteral9;
    // ----- call  ----- BoxedInt.ssc(74,17)
    call System.Console.WriteLine$System.String(stack0o);
    // ----- branch
    goto block13056;
  ...
  block13073:
    // ----- load constant 0.3  ----- BoxedInt.ssc(76,13)
    stack0r := real#0.30;
    // ----- call  ----- BoxedInt.ssc(76,11)
    call stack0i := BoxedInt.P$System.Double(stack0r);
    // ----- load constant "P(0.3) succeeded"  ----- BoxedInt.ssc(76,37)
    stack0o := $stringLiteral10;
    // ----- call  ----- BoxedInt.ssc(76,19)
    call System.Console.WriteLine$System.String(stack0o);
    // ----- branch
    goto block13175;
  ...
  block13192:
    // ----- load constant 5  ----- BoxedInt.ssc(78,13)
    stack0i := 5;
    // ----- box  ----- BoxedInt.ssc(78,13)
    havoc stack0o;
    assume Box(stack0i, stack0o) == stack0o;
    assume UnboxedType(stack0o) == System.Int32;
    assume $IsNotNull(stack0o, System.Object);
    assume $Heap[stack0o, $allocated] == true;
    assume ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[stack0o, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[stack0o, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc));
    // ----- call  ----- BoxedInt.ssc(78,11)
    call stack0i := BoxedInt.Q$System.Object(stack0o);
    // ----- load constant "Q(5) succeeded"  ----- BoxedInt.ssc(78,35)
    stack0o := $stringLiteral11;
    // ----- call  ----- BoxedInt.ssc(78,17)
    call System.Console.WriteLine$System.String(stack0o);
    // ----- branch
    goto block13294;
  ...
  block13311:
    // ----- load constant 7  ----- BoxedInt.ssc(80,13)
    stack0i := 7;
    // ----- call  ----- BoxedInt.ssc(80,11)
    call stack0i := BoxedInt.R$System.Int32(stack0i);
    // ----- load constant "R(7) succeeded"  ----- BoxedInt.ssc(80,35)
    stack0o := $stringLiteral12;
    // ----- call  ----- BoxedInt.ssc(80,17)
    call System.Console.WriteLine$System.String(stack0o);
    // ----- branch
    goto block13413;
  ...
  block13430:
    // ----- load constant 7  ----- BoxedInt.ssc(82,13)
    stack0i := 7;
    // ----- call  ----- BoxedInt.ssc(82,11)
    call stack0i := BoxedInt.S$System.Int32(stack0i);
    // ----- load constant "S(7) succeeded"  ----- BoxedInt.ssc(82,35)
    stack0o := $stringLiteral13;
    // ----- call  ----- BoxedInt.ssc(82,17)
    call System.Console.WriteLine$System.String(stack0o);
    // ----- branch
    goto block13532;
  ...
  block13549:
    // ----- load constant 18  ----- BoxedInt.ssc(84,13)
    stack0i := 18;
    // ----- call  ----- BoxedInt.ssc(84,11)
    call BoxedInt.T$System.Int32(stack0i);
    // ----- load constant "T(18) succeeded"  ----- BoxedInt.ssc(84,36)
    stack0o := $stringLiteral14;
    // ----- call  ----- BoxedInt.ssc(84,18)
    call System.Console.WriteLine$System.String(stack0o);
    // ----- branch
    goto block13651;
...
implementation BoxedInt..ctor(this: ref)
{
  ...
  entry:
    assume $IsNotNull(this, BoxedInt);
  ...
  block14161:
    ...
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == BoxedInt ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := BoxedInt;
    assume IsHeap($Heap);
    return;
...
axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral7, $allocated] } IsHeap(heap) ==> heap[$stringLiteral7, $allocated]) && $IsNotNull($stringLiteral7, System.String) && $StringLength($stringLiteral7) == 14;
...
axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral8, $allocated] } IsHeap(heap) ==> heap[$stringLiteral8, $allocated]) && $IsNotNull($stringLiteral8, System.String) && $StringLength($stringLiteral8) == 14;
...
axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral9, $allocated] } IsHeap(heap) ==> heap[$stringLiteral9, $allocated]) && $IsNotNull($stringLiteral9, System.String) && $StringLength($stringLiteral9) == 14;
...
axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral10, $allocated] } IsHeap(heap) ==> heap[$stringLiteral10, $allocated]) && $IsNotNull($stringLiteral10, System.String) && $StringLength($stringLiteral10) == 16;
...
axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral11, $allocated] } IsHeap(heap) ==> heap[$stringLiteral11, $allocated]) && $IsNotNull($stringLiteral11, System.String) && $StringLength($stringLiteral11) == 14;

axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral11, $allocated] } IsHeap(heap) ==> heap[$stringLiteral11, $allocated]) && $IsNotNull($stringLiteral11, System.String) && #System.String.IsInterned$System.String$notnull($stringLiteral11) == $stringLiteral11;

const $stringLiteral12: ref;

axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral12, $allocated] } IsHeap(heap) ==> heap[$stringLiteral12, $allocated]) && $IsNotNull($stringLiteral12, System.String) && $StringLength($stringLiteral12) == 14;

axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral12, $allocated] } IsHeap(heap) ==> heap[$stringLiteral12, $allocated]) && $IsNotNull($stringLiteral12, System.String) && #System.String.IsInterned$System.String$notnull($stringLiteral12) == $stringLiteral12;

const $stringLiteral13: ref;

axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral13, $allocated] } IsHeap(heap) ==> heap[$stringLiteral13, $allocated]) && $IsNotNull($stringLiteral13, System.String) && $StringLength($stringLiteral13) == 14;

axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral13, $allocated] } IsHeap(heap) ==> heap[$stringLiteral13, $allocated]) && $IsNotNull($stringLiteral13, System.String) && #System.String.IsInterned$System.String$notnull($stringLiteral13) == $stringLiteral13;

const $stringLiteral14: ref;

axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral14, $allocated] } IsHeap(heap) ==> heap[$stringLiteral14, $allocated]) && $IsNotNull($stringLiteral14, System.String) && $StringLength($stringLiteral14) == 15;

axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral14, $allocated] } IsHeap(heap) ==> heap[$stringLiteral14, $allocated]) && $IsNotNull($stringLiteral14, System.String) && #System.String.IsInterned$System.String$notnull($stringLiteral14) == $stringLiteral14;
