...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleWhile1.dll /infer:i
...
{
  var counter: int where InRange(counter, System.Int32), i: int where InRange(i, System.Int32), stack0i: int, stack0b: bool, stack1i: int, stack0o: ref, local2: int where InRange(local2, System.Int32), local3: int where InRange(local3, System.Int32), $Heap$block1360$LoopPreheader: [ref,<x>name]x;

  entry:
    assume $IsNotNull(this, SimpleWhile1);
  ...
  block1343:
    // ----- load constant 12  ----- SimpleWhile1.ssc(5,3)
    counter := 12;
    // ----- load constant 0  ----- SimpleWhile1.ssc(7,7)
    i := 0;
    goto block1360$LoopPreheader;

  block1360:
    // ----- default loop invariant: allocation and ownership are stable  ----- SimpleWhile1.ssc(7,16)
    assume (forall $o: ref :: $Heap$block1360$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block1360$LoopPreheader[$ot, $allocated] == true && $Heap$block1360$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block1360$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block1360$LoopPreheader[$ot, $ownerFrame]) && $Heap$block1360$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- SimpleWhile1.ssc(7,16)
    assume (forall $o: ref :: ($Heap$block1360$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block1360$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block1360$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block1360$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- SimpleWhile1.ssc(7,16)
    assert (forall $o: ref :: $o != null && $Heap$block1360$LoopPreheader[$o, $allocated] == true ==> $Heap$block1360$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block1360$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 100  ----- SimpleWhile1.ssc(7,16)
    stack0i := 100;
    // ----- binary operator  ----- SimpleWhile1.ssc(7,16)
    // ----- branch  ----- SimpleWhile1.ssc(7,16)
    goto true1360to1445, false1360to1377;
  ...
  block1445:
    // ----- serialized AssertStatement  ----- SimpleWhile1.ssc(15,3)
    assert counter >= -12;
    goto block1530;

  block1377:
    // ----- load constant 5  ----- SimpleWhile1.ssc(9,4)
    stack0i := 5;
    // ----- binary operator  ----- SimpleWhile1.ssc(9,4)
    assert stack0i != 0;
    stack0i := i % stack0i;
    // ----- load constant 0  ----- SimpleWhile1.ssc(9,4)
    stack1i := 0;
    // ----- binary operator  ----- SimpleWhile1.ssc(9,4)
    // ----- branch  ----- SimpleWhile1.ssc(9,4)
    goto true1377to1411, false1377to1394;
  ...
  block1411:
    // ----- copy  ----- SimpleWhile1.ssc(12,5)
    local2 := counter;
    // ----- load constant 1  ----- SimpleWhile1.ssc(12,5)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile1.ssc(12,5)
    stack0i := local2 + stack0i;
    // ----- copy  ----- SimpleWhile1.ssc(12,5)
    counter := stack0i;
    // ----- copy
    stack0i := local2;
    // ----- nop  ----- SimpleWhile1.ssc(12,14)
    goto block1428;

  block1394:
    // ----- load constant 11  ----- SimpleWhile1.ssc(10,5)
    stack0i := 11;
    // ----- binary operator  ----- SimpleWhile1.ssc(10,5)
    stack0i := counter - stack0i;
    // ----- copy  ----- SimpleWhile1.ssc(10,5)
    counter := stack0i;
    // ----- branch  ----- SimpleWhile1.ssc(11,4)
    goto block1428;

  block1530:
    // ----- nop
    // ----- return  ----- SimpleWhile1.ssc(16,2)
    return;

  block1428:
    // ----- copy  ----- SimpleWhile1.ssc(7,25)
    local3 := i;
    // ----- load constant 1  ----- SimpleWhile1.ssc(7,25)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile1.ssc(7,25)
  ...
  block1360$LoopPreheader:
    $Heap$block1360$LoopPreheader := $Heap;
    goto block1360;
...
implementation SimpleWhile1..ctor(this: ref)
{
  ...
  block2176:
    // ----- call  ----- SimpleWhile1.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleWhile1 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleWhile1;
    assume IsHeap($Heap);
    return;
