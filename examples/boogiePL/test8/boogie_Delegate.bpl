...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Delegate.dll
...
const Delegate.mdField: <ref>name;
...
{
  var md: ref where $Is(md, MyDelegate), stack0o: ref, stack1i: int, stack2o: ref;

  entry:
    assume $IsNotNull(this, Delegate);
  ...
  block1564:
    // ----- copy  ----- Delegate.ssc(6,5)
    stack0o := md;
    assert stack0o != null;
    stack0o := stack0o;
    // ----- load constant 5  ----- Delegate.ssc(6,5)
    stack1i := 5;
    // ----- copy  ----- Delegate.ssc(6,5)
    stack2o := this;
    // ----- call  ----- Delegate.ssc(6,5)
    assert stack0o != null;
    call MyDelegate.Invoke$System.Int32$System.Object$notnull$.Virtual.$(stack0o, stack1i, stack2o);
    // ----- return  ----- Delegate.ssc(7,3)
    return;
...
{
  var md: ref where $IsNotNull(md, MyDelegate), stack0i: int, stack1o: ref;
  ...
  block1989:
    // ----- nop
    // ----- load constant 5  ----- Delegate.ssc(9,5)
    stack0i := 5;
    // ----- copy  ----- Delegate.ssc(9,5)
    stack1o := this;
    // ----- call  ----- Delegate.ssc(9,5)
    assert md != null;
    call MyDelegate.Invoke$System.Int32$System.Object$notnull$.Virtual.$(md, stack0i, stack1o);
    // ----- return
    return;
...
{
  var md: ref where $Is(md, MyDelegate), stack0o: ref, stack0b: bool, stack0i: int, stack1o: ref;
  ...
  block2295:
    stack0o := null;
    // ----- binary operator  ----- Delegate.ssc(12,5)
    // ----- branch  ----- Delegate.ssc(12,5)
    goto true2295to2329, false2295to2312;
  ...
  block2329:
    // ----- return  ----- Delegate.ssc(15,3)
    return;

  block2312:
    // ----- load constant 5  ----- Delegate.ssc(13,7)
    stack0i := 5;
    // ----- copy  ----- Delegate.ssc(13,7)
    stack1o := this;
    // ----- call  ----- Delegate.ssc(13,7)
    assert md != null;
    call MyDelegate.Invoke$System.Int32$System.Object$notnull$.Virtual.$(md, stack0i, stack1o);
    goto block2329;
...
{
  var y: int where InRange(y, System.Int32), p: ref where $IsNotNull(p, System.Object);
...
{
  var stack0o: ref, stack1o: ref, stack50000o: ref, temp0: exposeVersionType;
  ...
  block2941:
    stack0o := null;
    // ----- load function  ----- Delegate.ssc(24,5)
    havoc stack1o;
    // ----- new object  ----- Delegate.ssc(24,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == MyDelegate;
    ...
    // ----- call  ----- Delegate.ssc(24,5)
    assert stack50000o != null;
    call MyDelegate..ctor$System.Object$System.IntPtr(stack50000o, stack0o, stack1o);
    // ----- copy  ----- Delegate.ssc(24,5)
    stack0o := stack50000o;
    // ----- store field  ----- Delegate.ssc(24,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Delegate.mdField] := stack0o;
    assume IsHeap($Heap);
    // ----- call  ----- Delegate.ssc(25,5)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return  ----- Delegate.ssc(26,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Delegate ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Delegate;
    assume IsHeap($Heap);
    return;
...
{
  var b: bool where true, stack0o: ref, stack1o: ref, stack50000o: ref, temp0: exposeVersionType;
  ...
  block3230:
    // ----- copy  ----- Delegate.ssc(29,5)
    stack0o := this;
    // ----- load function  ----- Delegate.ssc(29,5)
    havoc stack1o;
    // ----- new object  ----- Delegate.ssc(29,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == MyDelegate;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Delegate.ssc(29,5)
    assert stack50000o != null;
    call MyDelegate..ctor$System.Object$System.IntPtr(stack50000o, stack0o, stack1o);
    // ----- copy  ----- Delegate.ssc(29,5)
    stack0o := stack50000o;
    // ----- store field  ----- Delegate.ssc(29,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Delegate.mdField] := stack0o;
    assume IsHeap($Heap);
    // ----- call  ----- Delegate.ssc(30,5)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return  ----- Delegate.ssc(31,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Delegate ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Delegate;
...
{
  var z: int where InRange(z, System.Int32), s: ref where $IsNotNull(s, System.String), local1: ref where $Is(local1, Delegate), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, stack1i: int, stack2o: ref;
  ...
  block4080:
    // ----- nop
    // ----- copy  ----- Delegate.ssc(34,13)
    local1 := this;
    // ----- copy  ----- Delegate.ssc(34,13)
    stack0o := local1;
    // ----- load token  ----- Delegate.ssc(34,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Delegate);
    // ----- statically resolved GetTypeFromHandle call  ----- Delegate.ssc(34,13)
    stack1o := TypeObject(Delegate);
    // ----- local unpack  ----- Delegate.ssc(34,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: Delegate && $Heap[stack0o, $localinv] == $typeof(stack0o);
  ...
  block4097:
    // ----- load field  ----- Delegate.ssc(35,7)
    assert this != null;
    stack0o := $Heap[this, Delegate.mdField];
    // ----- copy  ----- Delegate.ssc(35,7)
    stack1i := z;
    // ----- copy  ----- Delegate.ssc(35,7)
    stack2o := s;
    // ----- call  ----- Delegate.ssc(35,7)
    assert stack0o != null;
    call MyDelegate.Invoke$System.Int32$System.Object$notnull$.Virtual.$(stack0o, stack1i, stack2o);
    // ----- branch
    goto block4148;
  ...
  block4148:
    // ----- copy  ----- Delegate.ssc(36,5)
    stack0o := local1;
    // ----- load token  ----- Delegate.ssc(36,5)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Delegate);
    // ----- statically resolved GetTypeFromHandle call  ----- Delegate.ssc(36,5)
    stack1o := TypeObject(Delegate);
    // ----- local pack  ----- Delegate.ssc(36,5)
    assert stack0o != null;
    assert $Heap[stack0o, $localinv] == System.Object;
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == stack0o && $Heap[$p, $ownerFrame] == Delegate ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
...
{
  var md: ref where $Is(md, MyDelegate), stack0o: ref, stack0b: bool, o: ref where $Is(o, System.Object), stack1o: ref, b: bool where true, stack2o: ref, stack1b: bool, return.value: bool where true, SS$Display.Return.Local: bool where true;
  ...
  block5049:
    stack0o := null;
    // ----- binary operator  ----- Delegate.ssc(43,5)
    // ----- branch  ----- Delegate.ssc(43,5)
  ...
  block5083:
    // ----- load field  ----- Delegate.ssc(46,7)
    assert this != null;
    o := $Heap[this, Delegate.mdField];
    // ----- nop  ----- Delegate.ssc(48,5)
    goto block5100;

  block5066:
    // ----- copy  ----- Delegate.ssc(44,7)
    o := md;
    // ----- branch  ----- Delegate.ssc(45,7)
    goto block5100;

  block5100:
    // ----- is instance  ----- Delegate.ssc(48,5)
    stack0o := $As(o, System.Object);
    stack1o := null;
    // ----- binary operator  ----- Delegate.ssc(48,5)
    // ----- branch  ----- Delegate.ssc(48,5)
    goto true5100to5134, false5100to5117;
  ...
  block5151:
    // ----- copy
    b := stack0b;
    // ----- copy  ----- Delegate.ssc(49,5)
    stack0b := b;
    // ----- unary operator  ----- Delegate.ssc(49,5)
    // ----- branch  ----- Delegate.ssc(49,5)
    goto true5151to5236, false5151to5168;
  ...
  block5168:
    // ----- is instance
    stack0o := $As(o, System.Delegate);
    stack1o := null;
    // ----- binary operator
    // ----- branch
    goto true5168to5202, false5168to5185;
  ...
  block5253:
    ...
    // ----- copy
    stack0b := b;
    // ----- is instance  ----- Delegate.ssc(50,5)
    stack1o := $As(o, System.MulticastDelegate);
    stack2o := null;
    // ----- binary operator  ----- Delegate.ssc(50,5)
    // ----- branch  ----- Delegate.ssc(50,5)
    goto true5253to5287, false5253to5270;

  true5253to5287:
    assume stack1o != stack2o;
    goto block5287;
  ...
  block5304:
    // ----- binary operator
    stack0b := stack0b && stack1b;
    // ----- copy
    b := stack0b;
    // ----- copy
    stack0b := b;
    // ----- is instance  ----- Delegate.ssc(51,5)
    stack1o := $As(o, System.Object);
    stack2o := null;
    // ----- binary operator  ----- Delegate.ssc(51,5)
    // ----- branch  ----- Delegate.ssc(51,5)
    goto true5304to5338, false5304to5321;
  ...
  block5457:
    ...
    // ----- copy  ----- Delegate.ssc(53,3)
    stack0b := return.value;
    // ----- return  ----- Delegate.ssc(53,3)
    $result := stack0b;
    return;
