...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify WhereClause.dll
...
{
  var x: ref where $Is(x, System.String), stack0o: ref, stack0b: bool;
  ...
  block1496:
    // ----- branch  ----- WhereClause.ssc(8,5)
    goto block1564;

  block1564:
    stack0o := null;
    // ----- binary operator  ----- WhereClause.ssc(9,5)
    // ----- branch  ----- WhereClause.ssc(9,5)
    goto true1564to1768, false1564to1581;
  ...
  block1768:
    // ----- return  ----- WhereClause.ssc(13,3)
    return;

  block1581:
    // ----- serialized AssertStatement  ----- WhereClause.ssc(10,7)
    assert $IsNotNull(x, System.Object);
    goto block1666;

  block1666:
    // ----- nop
    // ----- serialized AssertStatement  ----- WhereClause.ssc(11,7)
    assert $IsNotNull(x, System.String);
    goto block1751;
...
{
  var x: ref where $Is(x, System.String), y: ref where $Is(y, System.String), z: ref where $Is(z, System.String), stack1o: ref, stack0o: ref, stack0b: bool, return.value: ref where $Is(return.value, System.String), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.String);
  ...
  block3145:
    // ----- load constant "abc"  ----- WhereClause.ssc(19,5)
    stack1o := $stringLiteral2;
    // ----- store indirect  ----- WhereClause.ssc(19,5)
    z := stack1o;
    goto block3162;

  block3162:
    // ----- branch  ----- WhereClause.ssc(20,5)
    goto block3298;

  block3298:
    stack0o := null;
    // ----- binary operator  ----- WhereClause.ssc(25,5)
    // ----- branch  ----- WhereClause.ssc(25,5)
    goto true3298to3502, false3298to3315;
  ...
  block3502:
    // ----- load indirect  ----- WhereClause.ssc(29,5)
    stack0o := y;
    stack1o := null;
    // ----- binary operator  ----- WhereClause.ssc(29,5)
    // ----- branch  ----- WhereClause.ssc(29,5)
    goto true3502to3706, false3502to3519;

  block3315:
    // ----- serialized AssertStatement  ----- WhereClause.ssc(26,7)
    assert $IsNotNull(x, System.Object);
    goto block3400;
  ...
  block3706:
    // ----- load indirect  ----- WhereClause.ssc(33,5)
    stack0o := z;
    stack1o := null;
    // ----- binary operator  ----- WhereClause.ssc(33,5)
    // ----- branch  ----- WhereClause.ssc(33,5)
    goto true3706to3910, false3706to3723;

  block3519:
    // ----- serialized AssertStatement  ----- WhereClause.ssc(30,7)
    assert $IsNotNull(y, System.Object);
    goto block3604;
  ...
  block3910:
    // ----- store indirect  ----- WhereClause.ssc(37,5)
    z := x;
    // ----- copy  ----- WhereClause.ssc(38,5)
    return.value := x;
    // ----- branch
    goto block3927;

  block3723:
    // ----- serialized AssertStatement  ----- WhereClause.ssc(34,7)
    assert $IsNotNull(z, System.Object);
    goto block3808;

  block3400:
    // ----- nop
    // ----- serialized AssertStatement  ----- WhereClause.ssc(27,7)
    assert $IsNotNull(x, System.String);
    goto block3485;

  block3604:
    // ----- nop
    // ----- serialized AssertStatement  ----- WhereClause.ssc(31,7)
    assert $IsNotNull(y, System.String);
    goto block3689;
  ...
  block3927:
    ...
    // ----- copy  ----- WhereClause.ssc(39,3)
    stack0o := return.value;
    // ----- return  ----- WhereClause.ssc(39,3)
    y$out := y;
    z$out := z;
    $result := stack0o;
    return;
  ...
  block3808:
    // ----- nop
    // ----- serialized AssertStatement  ----- WhereClause.ssc(35,7)
    assert $IsNotNull(z, System.String);
    goto block3893;
