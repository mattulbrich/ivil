...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo FieldUpdateLoop
...
{
  var local2907: ref where $Is(local2907, Test), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, stack0i: int, temp1: exposeVersionType, $Heap$block2686$LoopPreheader: [ref,<x>name]x;
  ...
  block2669:
    // ----- copy  ----- FieldUpdateLoop.ssc(7,13)
    local2907 := this;
    // ----- copy  ----- FieldUpdateLoop.ssc(7,13)
    stack0o := local2907;
    // ----- load token  ----- FieldUpdateLoop.ssc(7,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Test);
    // ----- statically resolved GetTypeFromHandle call  ----- FieldUpdateLoop.ssc(7,13)
    stack1o := TypeObject(Test);
    // ----- local unpack  ----- FieldUpdateLoop.ssc(7,13)
    assert stack0o != null;
    ...
    assume IsHeap($Heap);
    goto block2686$LoopPreheader;

  block2686:
    // ----- default loop invariant: allocation and ownership are stable  ----- FieldUpdateLoop.ssc(11,18)
    assume (forall $o: ref :: $Heap$block2686$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block2686$LoopPreheader[$ot, $allocated] == true && $Heap$block2686$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block2686$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block2686$LoopPreheader[$ot, $ownerFrame]) && $Heap$block2686$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- FieldUpdateLoop.ssc(11,18)
    assume (forall $o: ref :: ($Heap$block2686$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block2686$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block2686$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block2686$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- FieldUpdateLoop.ssc(11,18)
    assert (forall $o: ref :: $o != null && $Heap$block2686$LoopPreheader[$o, $allocated] == true ==> $Heap$block2686$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block2686$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 1  ----- FieldUpdateLoop.ssc(11,18)
    stack0i := 1;
    // ----- store field  ----- FieldUpdateLoop.ssc(11,9)
    assert this != null;
    havoc temp1;
  ...
  block2703:
    // ----- branch  ----- FieldUpdateLoop.ssc(12,8)
    goto block2686;

  block2686$LoopPreheader:
    $Heap$block2686$LoopPreheader := $Heap;
    goto block2686;
...
implementation Test..ctor(this: ref)
{
  ...
  block3077:
    // ----- load constant 0  ----- FieldUpdateLoop.ssc(3,19)
    stack0i := 0;
    // ----- store field  ----- FieldUpdateLoop.ssc(3,3)
    assert this != null;
    havoc temp0;
