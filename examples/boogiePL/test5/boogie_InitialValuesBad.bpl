...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo InitialValuesBad
...
implementation Cell..ctor(this: ref)
{
  ...
  block2992:
    // ----- call  ----- InitialValuesBad.ssc(6,9)
    assert this != null;
    call System.Object..ctor(this);
    goto block3009;

  block3009:
    // ----- serialized AssertStatement  ----- InitialValuesBad.ssc(8,9)
    assert $Heap[this, Cell.Value] == 1;
    goto block3162;
  ...
  block3179:
    // ----- load field  ----- InitialValuesBad.ssc(9,9)
    assert this != null;
    local3604 := $Heap[this, Cell.Value];
    // ----- load constant 1  ----- InitialValuesBad.ssc(9,9)
    stack0i := 1;
    // ----- binary operator  ----- InitialValuesBad.ssc(9,9)
    stack0i := local3604 + stack0i;
    // ----- store field  ----- InitialValuesBad.ssc(9,9)
    assert this != null;
    assert !($Heap[this, $inv] <: Cell) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Cell.Value] := stack0i;
    assume IsHeap($Heap);
    // ----- copy  ----- InitialValuesBad.ssc(9,9)
    stack0i := local3604;
    goto block3196;

  block3196:
    // ----- nop  ----- InitialValuesBad.ssc(9,9)
    goto block3213;
  ...
  block3434:
    // ----- return  ----- InitialValuesBad.ssc(10,5)
    assert this != null;
...
implementation Test.Main()
{
  ...
  block3927:
    // ----- new object  ----- InitialValuesBad.ssc(17,21)
    havoc stack50000o;
    ...
    // ----- call  ----- InitialValuesBad.ssc(17,21)
    assert stack50000o != null;
    call Cell..ctor(stack50000o);
    // ----- copy  ----- InitialValuesBad.ssc(17,9)
    stack0o := stack50000o;
    // ----- copy  ----- InitialValuesBad.ssc(17,9)
    cell := stack0o;
    goto block3944;
  ...
  block3944:
    // ----- serialized AssertStatement  ----- InitialValuesBad.ssc(18,9)
  ...
  block4131:
    // ----- return  ----- InitialValuesBad.ssc(19,5)
    return;
...
implementation Test..ctor(this: ref)
{
  ...
  block4352:
    // ----- call  ----- InitialValuesBad.ssc(13,14)
    assert this != null;
    call System.Object..ctor(this);
    goto block4369;
