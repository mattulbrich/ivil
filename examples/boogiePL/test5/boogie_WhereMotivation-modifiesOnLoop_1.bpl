...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify WhereMotivation.dll /modifiesOnLoop
...
implementation Types.MLoop0(this: ref)
{
  ...
  block2805:
    ...
    // ----- default loop invariant: modifies  ----- WhereMotivation.ssc(22,5)
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old($o != this || $f != Types.x) && old($o != this || $f != $exposeVersion) ==> $Heap$block2805$LoopPreheader[$o, $f] == $Heap[$o, $f]);
...
implementation Types.MLoop1(this: ref)
{
  ...
  block4318:
    ...
    // ----- default loop invariant: modifies  ----- WhereMotivation.ssc(42,7)
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old($o != this || $f != Types.x) && old($o != this || $f != $exposeVersion) ==> $Heap$block4318$LoopPreheader[$o, $f] == $Heap[$o, $f]);
...
implementation Types.MLoop2(this: ref)
{
  ...
  block5729:
    ...
    // ----- default loop invariant: modifies  ----- WhereMotivation.ssc(60,7)
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old($o != this || $f != Types.x) && old($o != this || $f != $exposeVersion) ==> $Heap$block5729$LoopPreheader[$o, $f] == $Heap[$o, $f]);
...
implementation Types.SLoop0(this: ref)
{
  ...
  block8330:
    ...
    // ----- default loop invariant: modifies  ----- WhereMotivation.ssc(90,24)
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old($o != this || $f != Types.next) && old($o != this || $f != $exposeVersion) ==> $Heap$block8330$LoopPreheader[$o, $f] == $Heap[$o, $f]);
...
implementation Types.SLoop1(this: ref)
{
  ...
  block9571:
    ...
    // ----- default loop invariant: modifies  ----- WhereMotivation.ssc(103,23)
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old($o != this || $f != Types.next) && old($o != this || $f != $exposeVersion) ==> $Heap$block9571$LoopPreheader[$o, $f] == $Heap[$o, $f]);
