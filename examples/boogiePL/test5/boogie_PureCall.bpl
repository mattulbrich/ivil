...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo PureCall
...
function #Cell.get_Id(ref) returns (int);

function ##Cell.get_Id(exposeVersionType) returns (int);

function #Cell.id(ref) returns (int);

axiom (forall $r: ref :: InRange(#Cell.id($r), System.Int32));

function #Cell.get_Value([ref,<x>name]x, ref) returns (int);

function ##Cell.get_Value(exposeVersionType) returns (int);
...
function #Cell.get_Natural([ref,<x>name]x, ref) returns (int);

function ##Cell.get_Natural(exposeVersionType) returns (int);
...
function #Cell.get_FieldLikeProperty([ref,<x>name]x, ref) returns (int);

function ##Cell.get_FieldLikeProperty(exposeVersionType) returns (int);
...
implementation Cell.get_Id(this: ref) returns ($result: int)
{
  ...
  block4250:
    // ----- load field  ----- PureCall.ssc(23,10)
    assert this != null;
    return.value := #Cell.id(this);
    // ----- branch
    goto block4267;
  ...
  block4284:
    ...
    // ----- copy  ----- PureCall.ssc(24,7)
    stack0i := return.value;
    // ----- return  ----- PureCall.ssc(24,7)
    $result := stack0i;
    return;
...
axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #Cell.get_Value($Heap, this) } IsHeap($Heap) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[this, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc)) ==> InRange(#Cell.get_Value($Heap, this), System.Int32) && #Cell.get_Value($Heap, this) == $Heap[this, Cell.value]);

axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #Cell.get_Value($Heap, this) } this != null && $typeof(this) <: Cell && $Heap[this, $inv] == $typeof(this) && $Heap[this, $localinv] == $typeof(this) && IsHeap($Heap) && $Heap[this, $allocated] == true ==> #Cell.get_Value($Heap, this) == ##Cell.get_Value($Heap[this, $exposeVersion]));
...
implementation Cell.get_Value(this: ref) returns ($result: int)
{
  ...
  block4488:
    // ----- load field  ----- PureCall.ssc(31,10)
    assert this != null;
    return.value := $Heap[this, Cell.value];
    // ----- branch
    goto block4505;
  ...
  block4522:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- PureCall.ssc(32,7)
    stack0i := return.value;
    // ----- return  ----- PureCall.ssc(32,7)
    $result := stack0i;
    return;
...
{
  var local5066: ref where $Is(local5066, Cell), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, local5083: int where InRange(local5083, System.Int32), stack0i: int, temp1: exposeVersionType;
  ...
  block4879:
    // ----- copy  ----- PureCall.ssc(38,15)
    local5066 := this;
    // ----- copy  ----- PureCall.ssc(38,15)
    stack0o := local5066;
    // ----- load token  ----- PureCall.ssc(38,15)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Cell);
    // ----- statically resolved GetTypeFromHandle call  ----- PureCall.ssc(38,15)
    stack1o := TypeObject(Cell);
    // ----- local unpack  ----- PureCall.ssc(38,15)
    assert stack0o != null;
  ...
  block4896:
    // ----- load field  ----- PureCall.ssc(40,9)
    assert this != null;
    local5083 := $Heap[this, Cell.value];
    // ----- load constant 1  ----- PureCall.ssc(40,9)
    stack0i := 1;
    // ----- binary operator  ----- PureCall.ssc(40,9)
    stack0i := local5083 + stack0i;
    // ----- store field  ----- PureCall.ssc(40,9)
    assert this != null;
    havoc temp1;
    $Heap[this, $exposeVersion] := temp1;
    $Heap[this, Cell.value] := stack0i;
    assume IsHeap($Heap);
    // ----- copy  ----- PureCall.ssc(40,9)
    stack0i := local5083;
    goto block4913;

  block4913:
    // ----- nop  ----- PureCall.ssc(40,9)
    // ----- branch
    goto block5015;

  block5015:
    // ----- copy  ----- PureCall.ssc(41,7)
    stack0o := local5066;
    // ----- load token  ----- PureCall.ssc(41,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Cell);
    // ----- statically resolved GetTypeFromHandle call  ----- PureCall.ssc(41,7)
    stack1o := TypeObject(Cell);
    // ----- local pack  ----- PureCall.ssc(41,7)
    assert stack0o != null;
...
axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #Cell.get_Natural($Heap, this) } IsHeap($Heap) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[this, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc)) ==> InRange(#Cell.get_Natural($Heap, this), System.Int32) && 0 <= #Cell.get_Natural($Heap, this));

axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #Cell.get_Natural($Heap, this) } this != null && $typeof(this) <: Cell && $Heap[this, $inv] == $typeof(this) && $Heap[this, $localinv] == $typeof(this) && IsHeap($Heap) && $Heap[this, $allocated] == true ==> #Cell.get_Natural($Heap, this) == ##Cell.get_Natural($Heap[this, $exposeVersion]));
...
implementation Cell.get_Natural(this: ref) returns ($result: int)
{
  ...
  block5440:
    // ----- load constant 5  ----- PureCall.ssc(49,10)
    return.value := 5;
    // ----- branch
    goto block5457;
  ...
  block5678:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- PureCall.ssc(50,7)
    stack0i := return.value;
    // ----- return  ----- PureCall.ssc(50,7)
    $result := stack0i;
    return;
...
axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #Cell.get_FieldLikeProperty($Heap, this) } IsHeap($Heap) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[this, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc)) ==> InRange(#Cell.get_FieldLikeProperty($Heap, this), System.Int32) && #Cell.get_FieldLikeProperty($Heap, this) == $Heap[this, Cell.theField]);

axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #Cell.get_FieldLikeProperty($Heap, this) } this != null && $typeof(this) <: Cell && $Heap[this, $inv] == $typeof(this) && $Heap[this, $localinv] == $typeof(this) && IsHeap($Heap) && $Heap[this, $allocated] == true ==> #Cell.get_FieldLikeProperty($Heap, this) == ##Cell.get_FieldLikeProperty($Heap[this, $exposeVersion]));
...
implementation Cell.get_FieldLikeProperty(this: ref) returns ($result: int)
{
  ...
  block6137:
    // ----- load field  ----- PureCall.ssc(58,7)
    assert this != null;
    return.value := $Heap[this, Cell.theField];
    // ----- branch
    goto block6154;
  ...
  block6375:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- PureCall.ssc(59,5)
    stack0i := return.value;
    // ----- return  ----- PureCall.ssc(59,5)
    $result := stack0i;
    return;
...
implementation Cell.set_FieldLikeProperty$System.Int32(this: ref, value$in: int)
{
  ...
  block6817:
    // ----- store field  ----- PureCall.ssc(64,7)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Cell.theField] := value;
    assume IsHeap($Heap);
    goto block6834;
...
{
  var stack0i: int, stack50000o: ref, stack0o: ref, cell: ref where $Is(cell, Cell);
  ...
  block7786:
    // ----- load constant 5  ----- PureCall.ssc(73,28)
    stack0i := 5;
    // ----- new object  ----- PureCall.ssc(73,19)
    havoc stack50000o;
  ...
  block7803:
    // ----- serialized AssertStatement  ----- PureCall.ssc(74,7)
    assert #Cell.get_Id(cell) == 5;
    goto block7956;
  ...
  block7973:
    // ----- serialized AssertStatement  ----- PureCall.ssc(75,7)
    assert #Cell.get_Value($Heap, cell) == 0;
    goto block8126;
  ...
  block8143:
    // ----- call  ----- PureCall.ssc(76,7)
    assert cell != null;
    call Cell.Increment(cell);
    goto block8160;

  block8160:
    // ----- serialized AssertStatement  ----- PureCall.ssc(77,7)
    assert #Cell.get_Id(cell) == 5;
    goto block8313;
...
implementation Test.TestBad()
{
  ...
  block9129:
    // ----- load constant 5  ----- PureCall.ssc(82,28)
    stack0i := 5;
    // ----- new object  ----- PureCall.ssc(82,19)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Cell;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- PureCall.ssc(82,19)
    assert stack50000o != null;
    call Cell..ctor$System.Int32(stack50000o, stack0i);
    // ----- copy  ----- PureCall.ssc(82,7)
    stack0o := stack50000o;
    // ----- copy  ----- PureCall.ssc(82,7)
    cell := stack0o;
    goto block9146;
  ...
  block9146:
    // ----- serialized AssertStatement  ----- PureCall.ssc(83,7)
    assert #Cell.get_Id(cell) == 5;
    goto block9299;
  ...
  block9316:
    // ----- serialized AssertStatement  ----- PureCall.ssc(84,7)
    assert #Cell.get_Value($Heap, cell) == 0;
    goto block9469;
  ...
  block9486:
    // ----- call  ----- PureCall.ssc(85,7)
    assert cell != null;
    call Cell.Increment(cell);
    goto block9503;

  block9503:
    // ----- serialized AssertStatement  ----- PureCall.ssc(86,7)
    assert #Cell.get_Value($Heap, cell) == 0;
    goto block9656;
...
{
  var stack0i: int, stack50000o: ref, stack0o: ref, cell: ref where $Is(cell, Cell), x: int where InRange(x, System.Int32);
  ...
  block10489:
    // ----- load constant 10  ----- PureCall.ssc(91,28)
    stack0i := 10;
    // ----- new object  ----- PureCall.ssc(91,19)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Cell;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- PureCall.ssc(91,19)
    assert stack50000o != null;
    call Cell..ctor$System.Int32(stack50000o, stack0i);
    // ----- copy  ----- PureCall.ssc(91,7)
    stack0o := stack50000o;
    // ----- copy  ----- PureCall.ssc(91,7)
    cell := stack0o;
    goto block10506;
  ...
  block10506:
    // ----- call  ----- PureCall.ssc(92,7)
    assert cell != null;
    call x := Cell.get_Natural(cell);
    goto block10523;

  block10523:
    // ----- serialized AssertStatement  ----- PureCall.ssc(93,7)
    assert 0 <= x;
    goto block10676;
  ...
  block10693:
    // ----- call  ----- PureCall.ssc(94,7)
    assert cell != null;
    call Cell.Increment(cell);
    goto block10710;

  block10710:
    // ----- serialized AssertStatement  ----- PureCall.ssc(95,7)
    assert 0 <= #Cell.get_Natural($Heap, cell);
    goto block10863;
  ...
  block10880:
    // ----- serialized AssertStatement  ----- PureCall.ssc(96,7)
    assert false;
    return;
...
{
  var stack0i: int, stack50000o: ref, stack0o: ref, cell: ref where $Is(cell, Cell), x: int where InRange(x, System.Int32), y: int where InRange(y, System.Int32), cell2: ref where $Is(cell2, Cell);
  ...
  block12104:
    // ----- load constant 19  ----- PureCall.ssc(101,28)
    stack0i := 19;
    // ----- new object  ----- PureCall.ssc(101,19)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Cell;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- PureCall.ssc(101,19)
    assert stack50000o != null;
    call Cell..ctor$System.Int32(stack50000o, stack0i);
    // ----- copy  ----- PureCall.ssc(101,7)
    stack0o := stack50000o;
    // ----- copy  ----- PureCall.ssc(101,7)
    cell := stack0o;
    goto block12121;
  ...
  block12121:
    // ----- call  ----- PureCall.ssc(102,7)
    assert cell != null;
    call x := Cell.get_FieldLikeProperty(cell);
    goto block12138;

  block12138:
    // ----- serialized AssertStatement  ----- PureCall.ssc(103,7)
    assert x == #Cell.get_FieldLikeProperty($Heap, cell);
    goto block12291;
  ...
  block12308:
    // ----- load constant 200  ----- PureCall.ssc(105,32)
    stack0i := 200;
    // ----- call  ----- PureCall.ssc(105,7)
    assert cell != null;
    call Cell.set_FieldLikeProperty$System.Int32(cell, stack0i);
    goto block12325;

  block12325:
    // ----- call  ----- PureCall.ssc(106,7)
    assert cell != null;
    call y := Cell.get_FieldLikeProperty(cell);
    goto block12342;

  block12342:
    // ----- serialized AssertStatement  ----- PureCall.ssc(107,7)
    assert y == 200;
    goto block12495;
  ...
  block12512:
    // ----- load constant 0  ----- PureCall.ssc(109,29)
    stack0i := 0;
    // ----- new object  ----- PureCall.ssc(109,20)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Cell;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- PureCall.ssc(109,20)
    assert stack50000o != null;
    call Cell..ctor$System.Int32(stack50000o, stack0i);
    // ----- copy  ----- PureCall.ssc(109,7)
    stack0o := stack50000o;
    // ----- copy  ----- PureCall.ssc(109,7)
    cell2 := stack0o;
    goto block12529;
  ...
  block12529:
    // ----- call  ----- PureCall.ssc(110,7)
    assert cell2 != null;
    call x := Cell.get_FieldLikeProperty(cell2);
    goto block12546;

  block12546:
    // ----- serialized AssertStatement  ----- PureCall.ssc(112,7)
    assert #Cell.get_FieldLikeProperty($Heap, cell) == y;
    goto block12699;
  ...
  block12716:
    // ----- call  ----- PureCall.ssc(114,7)
    assert cell != null;
    call Cell.Increment(cell);
    goto block12733;

  block12733:
    // ----- serialized AssertStatement  ----- PureCall.ssc(115,7)
    assert #Cell.get_FieldLikeProperty($Heap, cell) == y;
    goto block12886;
