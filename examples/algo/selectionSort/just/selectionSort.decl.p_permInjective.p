...
problem
  $impl($not($eq($eq(seqGet(p as seq(int),i as int) as int,seqGet(p as seq(int),j as int) as int) as bool,$eq(i as int,j as int) as bool) as bool) as bool,$or($or($not(isPermN(p as seq(int)) as bool) as bool,$not(seqDom(p as seq(int),i as int) as bool) as bool) as bool,$not(seqDom(p as seq(int),j as int) as bool) as bool) as bool) as bool
