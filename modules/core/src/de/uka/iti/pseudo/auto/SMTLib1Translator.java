...
import static de.uka.iti.pseudo.auto.SMTLib1Translator.ExpressionType.FORMULA;
import static de.uka.iti.pseudo.auto.SMTLib1Translator.ExpressionType.INT;
import static de.uka.iti.pseudo.auto.SMTLib1Translator.ExpressionType.UNIVERSE;
...
public class SMTLib1Translator extends DefaultTermVisitor implements SMTLibTranslator {
     ...
     */
    public SMTLib1Translator(Environment env) {
    ...
    /* (non-Javadoc)
     * @see de.uka.iti.pseudo.auto.SMTLibTranslator#export(de.uka.iti.pseudo.term.Sequent, java.lang.Appendable)
     */
    @Override
