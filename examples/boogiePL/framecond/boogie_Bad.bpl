...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Bad
...
{
  var stack50000o: ref, stack0o: ref, cell1: ref where $Is(cell1, Cell);
  ...
  block3740:
    // ----- serialized AssertStatement  ----- Bad.ssc(19,9)
    assert $Heap[cell1, Cell.x] == 0;
    goto block3893;
