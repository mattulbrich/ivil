...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleWhile2.dll /infer:i
...
implementation SimpleWhile2.AMethod(this: ref)
{
  ...
  entry:
    assume $IsNotNull(this, SimpleWhile2);
  ...
  block1292:
    // ----- load constant 300476  ----- SimpleWhile2.ssc(6,3)
    i := int#300476;
    // ----- load constant 0  ----- SimpleWhile2.ssc(7,3)
    count := 0;
    goto block1309$LoopPreheader;

  block1309:
    // ----- default loop invariant: allocation and ownership are stable  ----- SimpleWhile2.ssc(9,3)
    ...
    // ----- default loop invariant: $inv field  ----- SimpleWhile2.ssc(9,3)
    ...
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- SimpleWhile2.ssc(9,3)
    ...
    // ----- load constant 0  ----- SimpleWhile2.ssc(9,3)
    stack0i := 0;
    // ----- binary operator  ----- SimpleWhile2.ssc(9,3)
    // ----- branch  ----- SimpleWhile2.ssc(9,3)
  ...
  block1343:
    // ----- serialized AssertStatement  ----- SimpleWhile2.ssc(15,3)
    assert count <= 0;
    goto block1428;

  block1326:
    // ----- copy  ----- SimpleWhile2.ssc(11,4)
    local2 := i;
    // ----- load constant 1  ----- SimpleWhile2.ssc(11,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile2.ssc(11,4)
    stack0i := local2 - stack0i;
    // ----- copy  ----- SimpleWhile2.ssc(11,4)
    i := stack0i;
    // ----- copy
    stack0i := local2;
    // ----- copy  ----- SimpleWhile2.ssc(12,4)
    local3 := count;
    // ----- load constant 1  ----- SimpleWhile2.ssc(12,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile2.ssc(12,4)
    stack0i := local3 - stack0i;
    // ----- copy  ----- SimpleWhile2.ssc(12,4)
    count := stack0i;
    // ----- copy
    stack0i := local3;
    // ----- branch  ----- SimpleWhile2.ssc(13,4)
    goto block1309;

  block1428:
    // ----- nop
    // ----- return  ----- SimpleWhile2.ssc(16,2)
    return;
...
implementation SimpleWhile2..ctor(this: ref)
{
  ...
  block1938:
    // ----- call  ----- SimpleWhile2.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleWhile2 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleWhile2;
    assume IsHeap($Heap);
    return;
