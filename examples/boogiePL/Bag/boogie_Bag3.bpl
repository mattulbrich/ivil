...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Bag3
...
implementation Bag.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block4777:
    // ----- load constant 0  ----- Bag3.ssc(8,13)
    stack0i := 0;
    // ----- load field  ----- Bag3.ssc(8,18)
    assert this != null;
    stack1i := $Heap[this, Bag.count];
    // ----- binary operator  ----- Bag3.ssc(8,13)
    // ----- branch
  ...
  block4794:
    // ----- load field  ----- Bag3.ssc(8,27)
    assert this != null;
    stack0i := $Heap[this, Bag.count];
    // ----- load field  ----- Bag3.ssc(8,36)
    assert this != null;
    stack1o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag3.ssc(8,36)
    assert stack1o != null;
    stack1i := $Length(stack1o);
    // ----- binary operator  ----- Bag3.ssc(8,27)
    // ----- branch
...
implementation Bag..ctor$System.Int32.array$notnull(this: ref, initialElements$in: ref)
{
  ...
  block5984:
    // ----- array length  ----- Bag3.ssc(12,23)
    assert initialElements != null;
    stack0i := $Length(initialElements);
    // ----- new array  ----- Bag3.ssc(12,5)
    assert 0 <= stack0i;
    havoc e;
  ...
  block6001:
    ...
    // ----- load constant 0  ----- Bag3.ssc(13,33)
    stack1i := 0;
    // ----- copy  ----- Bag3.ssc(13,36)
    stack2o := e;
    assert stack2o != null;
    stack2o := stack2o;
    // ----- load constant 0  ----- Bag3.ssc(13,39)
    stack3i := 0;
    // ----- array length  ----- Bag3.ssc(13,42)
    assert initialElements != null;
  ...
  block6188:
    // ----- FrameGuard processing  ----- Bag3.ssc(16,3)
    temp0 := this;
    // ----- classic pack  ----- Bag3.ssc(16,3)
    assert temp0 != null;
...
implementation Bag..ctor$System.Int32.array$notnull$System.Int32$System.Int32(this: ref, initialElements$in: ref, start$in: int, howMany$in: int)
{
  ...
  block7667:
    ...
    assert stack2o != null;
    stack2o := stack2o;
    // ----- load constant 0  ----- Bag3.ssc(24,43)
    stack3i := 0;
    // ----- binary operator  ----- Bag3.ssc(24,46)
  ...
  block7854:
    // ----- FrameGuard processing  ----- Bag3.ssc(27,3)
    temp0 := this;
    // ----- classic pack  ----- Bag3.ssc(27,3)
    assert temp0 != null;
    assert $Heap[temp0, $inv] == System.Object && $Heap[temp0, $localinv] == $typeof(temp0);
    assert 0 <= $Heap[temp0, Bag.count] && $Heap[temp0, Bag.count] <= $Length($Heap[temp0, Bag.elems]);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == temp0 && $Heap[$p, $ownerFrame] == Bag ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
...
implementation Bag.RemoveMin(this: ref) returns ($result: int)
{
  ...
  block8891:
    // ----- load constant 2147483647  ----- Bag3.ssc(31,5)
    m := int#2147483647;
    goto block8908;

  block8908:
    // ----- load constant 0  ----- Bag3.ssc(32,5)
    mindex := 0;
    goto block8925;

  block8925:
    // ----- load constant 0  ----- Bag3.ssc(33,10)
    i := 0;
    goto block8942$LoopPreheader;

  block8942:
    // ----- default loop invariant: allocation and ownership are stable  ----- Bag3.ssc(33,25)
    ...
    // ----- default loop invariant: $inv field  ----- Bag3.ssc(33,25)
    ...
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- Bag3.ssc(33,25)
    ...
    // ----- load field  ----- Bag3.ssc(33,25)
    assert this != null;
    stack0i := $Heap[this, Bag.count];
    // ----- binary operator  ----- Bag3.ssc(33,21)
    // ----- branch  ----- Bag3.ssc(33,21)
  ...
  block8976:
    // ----- copy  ----- Bag3.ssc(35,9)
    mindex := i;
    // ----- load field  ----- Bag3.ssc(36,13)
    assert this != null;
    stack0o := $Heap[this, Bag.elems];
    // ----- copy  ----- Bag3.ssc(36,19)
    stack1i := i;
    // ----- load element  ----- Bag3.ssc(36,9)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
  ...
  block9095:
    // ----- load field  ----- Bag3.ssc(39,5)
    assert this != null;
    local9333 := $Heap[this, Bag.count];
    // ----- load constant 1  ----- Bag3.ssc(39,5)
    stack0i := 1;
    // ----- binary operator  ----- Bag3.ssc(39,5)
    stack0i := local9333 - stack0i;
    // ----- store field  ----- Bag3.ssc(39,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Bag) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Bag.count] := stack0i;
    assume IsHeap($Heap);
  ...
  block9027:
    // ----- copy  ----- Bag3.ssc(33,32)
    local9384 := i;
    // ----- load constant 1  ----- Bag3.ssc(33,32)
    stack0i := 1;
    // ----- binary operator  ----- Bag3.ssc(33,32)
...
implementation Bag.Add$System.Int32(this: ref, x$in: int)
{
  ...
  block10047:
    // ----- load field  ----- Bag3.ssc(46,9)
    assert this != null;
    stack0i := $Heap[this, Bag.count];
    // ----- load field  ----- Bag3.ssc(46,18)
    assert this != null;
    stack1o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag3.ssc(46,18)
    assert stack1o != null;
    stack1i := $Length(stack1o);
    // ----- binary operator  ----- Bag3.ssc(46,9)
    // ----- branch  ----- Bag3.ssc(46,5)
  ...
  block10064:
    // ----- load constant 2  ----- Bag3.ssc(48,26)
    stack0i := 2;
    // ----- load field  ----- Bag3.ssc(48,28)
    assert this != null;
    stack1o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag3.ssc(48,28)
    assert stack1o != null;
    stack1i := $Length(stack1o);
    // ----- binary operator  ----- Bag3.ssc(48,26)
    stack0i := stack0i * stack1i;
    // ----- new array  ----- Bag3.ssc(48,7)
    assert 0 <= stack0i;
    havoc b;
  ...
  block10081:
    // ----- load field  ----- Bag3.ssc(49,18)
    assert this != null;
    stack0o := $Heap[this, Bag.elems];
    // ----- load constant 0  ----- Bag3.ssc(49,25)
    stack1i := 0;
    // ----- copy  ----- Bag3.ssc(49,28)
    stack2o := b;
    // ----- load constant 0  ----- Bag3.ssc(49,31)
    stack3i := 0;
    // ----- load field  ----- Bag3.ssc(49,34)
    assert this != null;
    stack4o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag3.ssc(49,34)
    assert stack4o != null;
    stack4i := $Length(stack4o);
    // ----- call  ----- Bag3.ssc(49,7)
    call System.Array.Copy$System.Array$notnull$System.Int32$System.Array$notnull$System.Int32$System.Int32(stack0o, stack1i, stack2o, stack3i, stack4i);
    // ----- store field  ----- Bag3.ssc(50,7)
    assert this != null;
    assert !($Heap[this, $inv] <: Bag) || $Heap[this, $localinv] == System.Object;
  ...
  block10132:
    // ----- load field  ----- Bag3.ssc(52,5)
    assert this != null;
    stack0o := $Heap[this, Bag.elems];
    // ----- load field  ----- Bag3.ssc(52,11)
    assert this != null;
    stack1i := $Heap[this, Bag.count];
    // ----- store element  ----- Bag3.ssc(52,5)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
  ...
  block10149:
    // ----- load field  ----- Bag3.ssc(53,5)
    assert this != null;
    local10353 := $Heap[this, Bag.count];
    // ----- load constant 1  ----- Bag3.ssc(53,5)
    stack0i := 1;
    // ----- binary operator  ----- Bag3.ssc(53,5)
    stack0i := local10353 + stack0i;
    // ----- store field  ----- Bag3.ssc(53,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Bag) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Bag.count] := stack0i;
    assume IsHeap($Heap);
