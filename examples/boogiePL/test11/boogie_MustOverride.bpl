...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify MustOverride.dll
...
{
  var stack0o: ref, stack1s: struct, stack1o: ref, stack0b: bool, stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);

  entry:
    assume $IsNotNull(this, Ex1.B);
  ...
  block1819:
    // ----- System.Object.GetType  ----- MustOverride.ssc(8,7)
    stack0o := TypeObject($typeof(this));
    // ----- load token  ----- MustOverride.ssc(8,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Ex1.B);
    // ----- statically resolved GetTypeFromHandle call  ----- MustOverride.ssc(8,7)
    stack1o := TypeObject(Ex1.B);
    // ----- binary operator  ----- MustOverride.ssc(8,7)
    // ----- branch  ----- MustOverride.ssc(8,7)
    goto true1819to1853, false1819to1836;
  ...
  block1972:
    ...
    // ----- copy  ----- MustOverride.ssc(9,5)
    stack0i := return.value;
    // ----- return  ----- MustOverride.ssc(9,5)
    $result := stack0i;
    return;
...
implementation Ex1.B..ctor(this: ref)
{
  ...
  block2397:
    // ----- call  ----- MustOverride.ssc(4,16)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Ex1.B ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Ex1.B;
    assume IsHeap($Heap);
    return;
...
implementation Ex2.B.foo(this: ref) returns ($result: int)
{
  ...
  block2737:
    // ----- System.Object.GetType  ----- MustOverride.ssc(19,7)
    stack0o := TypeObject($typeof(this));
    // ----- load token  ----- MustOverride.ssc(19,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Ex2.B);
    // ----- statically resolved GetTypeFromHandle call  ----- MustOverride.ssc(19,7)
    stack1o := TypeObject(Ex2.B);
    // ----- binary operator  ----- MustOverride.ssc(19,7)
    // ----- branch  ----- MustOverride.ssc(19,7)
    goto true2737to2771, false2737to2754;
  ...
  block2890:
    ...
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- MustOverride.ssc(20,5)
    stack0i := return.value;
    // ----- return  ----- MustOverride.ssc(20,5)
    $result := stack0i;
    return;
...
implementation Ex2.B..ctor(this: ref)
{
  ...
  block3315:
    // ----- call  ----- MustOverride.ssc(14,16)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Ex2.B ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Ex2.B;
    assume IsHeap($Heap);
    return;
...
implementation Ex3.B.foo(this: ref) returns ($result: int)
{
  ...
  block3655:
    // ----- System.Object.GetType  ----- MustOverride.ssc(30,7)
    stack0o := TypeObject($typeof(this));
    // ----- load token  ----- MustOverride.ssc(30,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Ex3.B);
    // ----- statically resolved GetTypeFromHandle call  ----- MustOverride.ssc(30,7)
    stack1o := TypeObject(Ex3.B);
    // ----- binary operator  ----- MustOverride.ssc(30,7)
    // ----- branch  ----- MustOverride.ssc(30,7)
    goto true3655to3689, false3655to3672;
  ...
  block3808:
    ...
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- MustOverride.ssc(31,5)
    stack0i := return.value;
    // ----- return  ----- MustOverride.ssc(31,5)
    $result := stack0i;
    return;
...
implementation Ex3.B..ctor(this: ref)
{
  ...
  block4233:
    // ----- call  ----- MustOverride.ssc(25,16)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Ex3.B ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Ex3.B;
    assume IsHeap($Heap);
    return;
...
implementation Ex3.C.foo(this: ref) returns ($result: int)
{
  ...
  block4624:
    // ----- System.Object.GetType  ----- MustOverride.ssc(38,7)
    stack0o := TypeObject($typeof(this));
    // ----- load token  ----- MustOverride.ssc(38,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Ex3.B);
    // ----- statically resolved GetTypeFromHandle call  ----- MustOverride.ssc(38,7)
    stack1o := TypeObject(Ex3.B);
    // ----- binary operator  ----- MustOverride.ssc(38,7)
    // ----- branch  ----- MustOverride.ssc(38,7)
    goto true4624to4658, false4624to4641;
  ...
  block4828:
    ...
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- MustOverride.ssc(39,5)
    stack0i := return.value;
    // ----- return  ----- MustOverride.ssc(39,5)
    $result := stack0i;
    return;
...
implementation Ex3.C..ctor(this: ref)
{
  ...
  block5253:
    // ----- call  ----- MustOverride.ssc(33,16)
    assert this != null;
    call Ex3.B..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == Ex3.B && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Ex3.C ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Ex3.C;
    assume IsHeap($Heap);
    return;
...
implementation Ex4.B.foo(this: ref) returns ($result: int)
{
  ...
  block5593:
    // ----- System.Object.GetType  ----- MustOverride.ssc(49,7)
    stack0o := TypeObject($typeof(this));
    // ----- load token  ----- MustOverride.ssc(49,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Ex4.B);
    // ----- statically resolved GetTypeFromHandle call  ----- MustOverride.ssc(49,7)
    stack1o := TypeObject(Ex4.B);
    // ----- binary operator  ----- MustOverride.ssc(49,7)
    // ----- branch  ----- MustOverride.ssc(49,7)
    goto true5593to5627, false5593to5610;
  ...
  block5746:
    ...
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- MustOverride.ssc(50,5)
    stack0i := return.value;
    // ----- return  ----- MustOverride.ssc(50,5)
    $result := stack0i;
    return;
...
implementation Ex4.B..ctor(this: ref)
{
  ...
  block6171:
    // ----- call  ----- MustOverride.ssc(44,16)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Ex4.B ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Ex4.B;
    assume IsHeap($Heap);
    return;
...
implementation Ex4.C.foo(this: ref) returns ($result: int)
{
  ...
  block6562:
    // ----- System.Object.GetType  ----- MustOverride.ssc(57,7)
    stack0o := TypeObject($typeof(this));
    // ----- load token  ----- MustOverride.ssc(57,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Ex4.C);
    // ----- statically resolved GetTypeFromHandle call  ----- MustOverride.ssc(57,7)
    stack1o := TypeObject(Ex4.C);
    // ----- binary operator  ----- MustOverride.ssc(57,7)
    // ----- branch  ----- MustOverride.ssc(57,7)
    goto true6562to6596, false6562to6579;
  ...
  block6766:
    ...
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- MustOverride.ssc(58,5)
    stack0i := return.value;
    // ----- return  ----- MustOverride.ssc(58,5)
    $result := stack0i;
    return;
...
implementation Ex4.C..ctor(this: ref)
{
  ...
  block7191:
    // ----- call  ----- MustOverride.ssc(52,16)
    assert this != null;
    call Ex4.B..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == Ex4.B && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Ex4.C ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Ex4.C;
    assume IsHeap($Heap);
    return;
