...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker4
...
{
  var stack0o: ref, stack1i: int, stack2i: int, s: ref where $Is(s, System.String), stack0i: int, temp0: exposeVersionType, return.value: ref where $IsNotNull(return.value, System.String), SS$Display.Return.Local: ref where $IsNotNull(SS$Display.Return.Local, System.String);
  ...
  block3417:
    ...
    // ----- copy  ----- Chunker4.ssc(13,3)
    stack0o := return.value;
    // ----- return  ----- Chunker4.ssc(13,3)
    $result := stack0o;
    return;
...
{
  var source: ref where $IsNotNull(source, System.String), chunkSize: int where InRange(chunkSize, System.Int32), temp0: exposeVersionType, stack0i: int, temp1: exposeVersionType;
