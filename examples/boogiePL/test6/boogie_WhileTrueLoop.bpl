...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo WhileTrueLoop
...
{
  var $Heap$block2431$LoopPreheader: [ref,<x>name]x;
  ...
  block2414:
    goto block2431$LoopPreheader;

  block2431:
    // ----- default loop invariant: allocation and ownership are stable  ----- WhileTrueLoop.ssc(6,5)
    assume (forall $o: ref :: $Heap$block2431$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block2431$LoopPreheader[$ot, $allocated] == true && $Heap$block2431$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block2431$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block2431$LoopPreheader[$ot, $ownerFrame]) && $Heap$block2431$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- WhileTrueLoop.ssc(6,5)
    assume (forall $o: ref :: ($Heap$block2431$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block2431$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block2431$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block2431$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- WhileTrueLoop.ssc(6,5)
    assert (forall $o: ref :: $o != null && $Heap$block2431$LoopPreheader[$o, $allocated] == true ==> $Heap$block2431$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block2431$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    goto block2448;

  block2448:
    // ----- branch  ----- WhileTrueLoop.ssc(7,6)
    goto block2431;

  block2431$LoopPreheader:
    $Heap$block2431$LoopPreheader := $Heap;
    goto block2431;
