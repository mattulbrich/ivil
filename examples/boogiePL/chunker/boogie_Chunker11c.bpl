...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker11c
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3859:
    // ----- load constant 0  ----- Chunker11c.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker11c.ssc(7,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker11c.ssc(7,13)
    // ----- branch
  ...
  block4012:
    // ----- load constant 0  ----- Chunker11c.ssc(9,13)
    stack0i := 0;
    // ----- load field  ----- Chunker11c.ssc(9,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker11c.ssc(9,13)
    // ----- branch
  ...
  block4029:
    // ----- load field  ----- Chunker11c.ssc(9,23)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11c.ssc(9,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker11c.ssc(9,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker11c.ssc(9,23)
    // ----- branch
  ...
  block4097:
    assume false;
    // ----- new object  ----- Chunker11c.ssc(9,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker11c.ssc(9,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker11c.ssc(9,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker11c.ssc(9,3)
    assert stack0o != null;
    assume false;
    return;
...
implementation Chunker.NextChunk(this: ref) returns ($result: ref)
{
  ...
  block5661:
    // ----- FrameGuard processing  ----- Chunker11c.ssc(14,22)
    temp0 := this;
    // ----- classic unpack  ----- Chunker11c.ssc(14,22)
    assert temp0 != null;
  ...
  block5695:
    // ----- load field  ----- Chunker11c.ssc(16,11)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11c.ssc(16,15)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker11c.ssc(16,11)
    stack0i := stack0i + stack1i;
    // ----- load field  ----- Chunker11c.ssc(16,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker11c.ssc(16,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker11c.ssc(16,11)
    // ----- branch  ----- Chunker11c.ssc(16,7)
  ...
  block5746:
    // ----- load field  ----- Chunker11c.ssc(19,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker11c.ssc(19,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- call  ----- Chunker11c.ssc(19,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32(stack0o, stack1i);
    // ----- nop  ----- Chunker11c.ssc(21,7)
    goto block5763;

  block5712:
    // ----- load field  ----- Chunker11c.ssc(17,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker11c.ssc(17,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11c.ssc(17,30)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker11c.ssc(17,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i);
    goto block5729;

  block5729:
    // ----- branch  ----- Chunker11c.ssc(18,9)
    goto block5763;
  ...
  block5780:
    // ----- load field  ----- Chunker11c.ssc(21,7)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11c.ssc(21,12)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker11c.ssc(21,7)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker11c.ssc(21,7)
    assert this != null;
  ...
  block6307:
    // ----- classic pack  ----- Chunker11c.ssc(23,5)
    assert temp0 != null;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block7837:
    // ----- store field  ----- Chunker11c.ssc(29,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker11c.ssc(30,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker11c.ssc(31,9)
    stack0i := 0;
    // ----- store field  ----- Chunker11c.ssc(31,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block8024:
    // ----- FrameGuard processing  ----- Chunker11c.ssc(33,3)
    temp0 := this;
    // ----- classic pack  ----- Chunker11c.ssc(33,3)
    assert temp0 != null;
    assert $Heap[temp0, $inv] == System.Object && $Heap[temp0, $localinv] == $typeof(temp0);
    assert 0 < $Heap[temp0, Chunker.ChunkSize];
    assert 0 <= $Heap[temp0, Chunker.n] && $Heap[temp0, Chunker.n] <= $StringLength($Heap[temp0, Chunker.src]);
