...
public final class JMLParser {
    ...
    private static boolean cacheParser = false;
    ...
    public static JMLStatement parseJMLStatement(ByteArrayInputStream in) throws ParseException {
        return new ASTParser(in, null).JMLStatement();
    }
}
