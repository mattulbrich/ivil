(* created : Thu Feb 28 14:44:41 CET 2013 - Alpha-3 *)
#
...
program Java source "./BFS.jspec"
  ...
  LabelEnd:
   ...
   sourceline 9
    assert -1 <= resInt & resInt < arrlen(_array) ; "Assert postcondition"
   sourceline 10
    assert resInt >= 0 -> h[_array, idxBool(resInt)] &
                     (\forall i; 0<=i & i<resInt -> !h[_array, idxBool(i)]) ; "Assert postcondition"
   sourceline 12
