...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Branching.dll
...
{
  var t: ref where $IsNotNull(t, T), y: int where InRange(y, System.Int32), stack0i: int, stack0b: bool, stack1i: int, stack0o: ref;
  ...
  block1955:
    // ----- nop
    // ----- load constant 3  ----- Branching.ssc(13,5)
    stack0i := 3;
    // ----- binary operator  ----- Branching.ssc(13,5)
    // ----- branch  ----- Branching.ssc(13,5)
    goto true1955to2006, false1955to1972;
  ...
  block2006:
    // ----- load field  ----- Branching.ssc(16,5)
    assert t != null;
    stack0i := $Heap[t, T.x];
    // ----- load constant 3  ----- Branching.ssc(16,5)
    stack1i := 3;
    // ----- binary operator  ----- Branching.ssc(16,5)
    // ----- branch  ----- Branching.ssc(16,5)
    goto true2006to2040, false2006to2023;
  ...
  block1972:
    ...
    // ----- binary operator
    // ----- branch
    goto true1972to2006, false1972to1989;
  ...
  block1989:
    // ----- copy  ----- Branching.ssc(14,7)
    stack0o := t;
    // ----- copy  ----- Branching.ssc(14,7)
    stack1i := y;
    // ----- call  ----- Branching.ssc(14,7)
    assert this != null;
    call T.M$T$notnull$System.Int32(this, stack0o, stack1i);
    goto block2006;
  ...
  block2040:
    stack0o := null;
    // ----- binary operator  ----- Branching.ssc(19,5)
    // ----- branch  ----- Branching.ssc(19,5)
    goto true2040to2074, false2040to2057;

  block2023:
    // ----- copy  ----- Branching.ssc(17,7)
    stack0o := t;
    // ----- copy  ----- Branching.ssc(17,7)
    stack1i := y;
    // ----- call  ----- Branching.ssc(17,7)
    assert this != null;
    call T.M$T$notnull$System.Int32(this, stack0o, stack1i);
    goto block2040;
  ...
  block2074:
    stack0o := null;
    // ----- binary operator  ----- Branching.ssc(22,5)
    // ----- branch  ----- Branching.ssc(22,5)
    goto true2074to2108, false2074to2091;

  block2057:
    // ----- copy  ----- Branching.ssc(20,7)
    stack0o := t;
    // ----- copy  ----- Branching.ssc(20,7)
    stack1i := y;
    // ----- call  ----- Branching.ssc(20,7)
    assert this != null;
    call T.M$T$notnull$System.Int32(this, stack0o, stack1i);
    goto block2074;
  ...
  block2125:
    ...
    goto true2125to2159, false2125to2142;
  ...
  block2176:
    // ----- branch (no expression improvement)
    goto true2176to2210, false2176to2193;
  ...
  block2210:
    // ----- load constant 3  ----- Branching.ssc(25,5)
    stack0i := 3;
    // ----- binary operator  ----- Branching.ssc(25,5)
    // ----- branch  ----- Branching.ssc(25,5)
    goto true2210to2244, false2210to2227;

  block2193:
    // ----- copy  ----- Branching.ssc(23,7)
    stack0o := t;
    // ----- copy  ----- Branching.ssc(23,7)
    stack1i := y;
    // ----- call  ----- Branching.ssc(23,7)
    assert this != null;
    call T.M$T$notnull$System.Int32(this, stack0o, stack1i);
    goto block2210;
  ...
  block2261:
    // ----- branch (no expression improvement)
    goto true2261to2295, false2261to2278;
  ...
  block2312:
    // ----- branch (no expression improvement)
    goto true2312to2346, false2312to2329;
  ...
  block2346:
    // ----- load constant 3  ----- Branching.ssc(28,5)
    stack0i := 3;
    // ----- binary operator  ----- Branching.ssc(28,5)
    // ----- branch  ----- Branching.ssc(28,5)
    goto true2346to2431, false2346to2363;

  block2329:
    // ----- copy  ----- Branching.ssc(26,7)
    stack0o := t;
    // ----- copy  ----- Branching.ssc(26,7)
    stack1i := y;
    // ----- call  ----- Branching.ssc(26,7)
    assert this != null;
    call T.M$T$notnull$System.Int32(this, stack0o, stack1i);
    goto block2346;
  ...
  block2363:
    ...
    // ----- binary operator
    // ----- branch
    goto true2363to2397, false2363to2380;
  ...
  block2448:
    // ----- branch (no expression improvement)
    goto true2448to2482, false2448to2465;
  ...
  block2499:
    // ----- branch (no expression improvement)
    goto true2499to2533, false2499to2516;
  ...
  block2516:
    // ----- copy  ----- Branching.ssc(29,7)
    stack0o := t;
    // ----- copy  ----- Branching.ssc(29,7)
    stack1i := y;
    // ----- call  ----- Branching.ssc(29,7)
    assert this != null;
    call T.M$T$notnull$System.Int32(this, stack0o, stack1i);
    goto block2533;
...
{
  var c: bool where true, stack0b: bool, stack0i: int, stack0o: ref, k: int where InRange(k, System.Int32);
  ...
  block4335:
    // ----- load field  ----- Branching.ssc(36,5)
    assert this != null;
    stack0b := $Heap[this, T.b];
    // ----- unary operator  ----- Branching.ssc(36,5)
    // ----- branch  ----- Branching.ssc(36,5)
    goto true4335to4369, false4335to4352;
  ...
  block4369:
    // ----- copy  ----- Branching.ssc(37,5)
    stack0b := c;
    // ----- unary operator  ----- Branching.ssc(37,5)
    // ----- branch  ----- Branching.ssc(37,5)
    goto true4369to4403, false4369to4386;

  block4352:
    // ----- copy  ----- Branching.ssc(36,14)
    stack0b := c;
    // ----- call  ----- Branching.ssc(36,14)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4369;
  ...
  block4403:
    // ----- load field  ----- Branching.ssc(38,5)
    assert this != null;
    stack0b := $Heap[this, T.b];
    // ----- unary operator  ----- Branching.ssc(38,5)
    // ----- branch  ----- Branching.ssc(38,5)
    goto true4403to4454, false4403to4420;

  block4386:
    // ----- copy  ----- Branching.ssc(37,14)
    stack0b := c;
    // ----- call  ----- Branching.ssc(37,14)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4403;
  ...
  block4454:
    // ----- copy  ----- Branching.ssc(39,5)
    // ----- branch  ----- Branching.ssc(39,5)
    goto true4454to4488, false4454to4471;
  ...
  block4420:
    ...
    // ----- unary operator
    // ----- branch
    goto true4420to4454, false4420to4437;
  ...
  block4488:
    // ----- copy  ----- Branching.ssc(40,5)
    // ----- branch  ----- Branching.ssc(40,5)
    goto true4488to4522, false4488to4505;

  block4471:
    // ----- copy  ----- Branching.ssc(39,15)
    stack0b := c;
    // ----- call  ----- Branching.ssc(39,15)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4488;
  ...
  block4437:
    // ----- copy  ----- Branching.ssc(38,19)
    stack0b := c;
    // ----- call  ----- Branching.ssc(38,19)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4454;
  ...
  block4539:
    // ----- branch (no expression improvement)
    goto true4539to4573, false4539to4556;
  ...
  block4573:
    // ----- load field  ----- Branching.ssc(41,5)
    assert this != null;
    stack0i := $Heap[this, T.x];
    // ----- call  ----- Branching.ssc(41,5)
    assert this != null;
    call stack0b := T.P$System.Int32(this, stack0i);
    // ----- unary operator  ----- Branching.ssc(41,5)
    // ----- branch  ----- Branching.ssc(41,5)
    goto true4573to4607, false4573to4590;

  block4556:
    // ----- copy  ----- Branching.ssc(40,16)
    stack0b := c;
    // ----- call  ----- Branching.ssc(40,16)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4573;
  ...
  block4607:
    // ----- load field  ----- Branching.ssc(42,5)
    assert this != null;
    stack0i := $Heap[this, T.x];
    // ----- call  ----- Branching.ssc(42,5)
    assert this != null;
    call stack0b := T.P$System.Int32(this, stack0i);
    // ----- branch (no expression improvement)  ----- Branching.ssc(42,5)
    goto true4607to4641, false4607to4624;

  block4590:
    // ----- copy  ----- Branching.ssc(41,17)
    stack0b := c;
    // ----- call  ----- Branching.ssc(41,17)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4607;
  ...
  block4641:
    // ----- load address  ----- Branching.ssc(44,5)
    havoc stack0o;
    // ----- call  ----- Branching.ssc(44,5)
    assert this != null;
    call stack0b, k := T.Q$System.Int32.ptr(this);
    // ----- unary operator  ----- Branching.ssc(44,5)
    // ----- branch  ----- Branching.ssc(44,5)
    goto true4641to4675, false4641to4658;

  block4624:
    // ----- copy  ----- Branching.ssc(42,18)
    stack0b := c;
    // ----- call  ----- Branching.ssc(42,18)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4641;
  ...
  block4675:
    // ----- load address  ----- Branching.ssc(45,5)
    havoc stack0o;
    // ----- call  ----- Branching.ssc(45,5)
    assert this != null;
    call stack0b, k := T.Q$System.Int32.ptr(this);
    // ----- branch (no expression improvement)  ----- Branching.ssc(45,5)
    goto true4675to4709, false4675to4692;

  block4658:
    // ----- copy  ----- Branching.ssc(44,21)
    stack0b := c;
    // ----- call  ----- Branching.ssc(44,21)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4675;
  ...
  block4709:
    // ----- return  ----- Branching.ssc(46,3)
    return;

  block4692:
    // ----- copy  ----- Branching.ssc(45,22)
    stack0b := c;
    // ----- call  ----- Branching.ssc(45,22)
    assert this != null;
    call T.N$System.Boolean(this, stack0b);
    goto block4709;
...
{
  var z: int where InRange(z, System.Int32), return.value: bool where true, SS$Display.Return.Local: bool where true, stack0b: bool;
  ...
  block5780:
    // ----- load constant 1  ----- Branching.ssc(48,26)
    return.value := true;
    // ----- branch
    goto block5797;
  ...
  block5797:
    ...
    // ----- copy  ----- Branching.ssc(48,39)
    stack0b := return.value;
    // ----- return  ----- Branching.ssc(48,39)
    $result := stack0b;
    return;
...
{
  var k: int where InRange(k, System.Int32), stack1i: int, return.value: bool where true, SS$Display.Return.Local: bool where true, stack0b: bool;
  ...
  block6052:
    // ----- load constant 5  ----- Branching.ssc(49,30)
    stack1i := 5;
    // ----- store indirect  ----- Branching.ssc(49,30)
    k := stack1i;
    // ----- load constant 0  ----- Branching.ssc(49,37)
    return.value := false;
    // ----- branch
    goto block6069;
  ...
  block6069:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- Branching.ssc(49,51)
    stack0b := return.value;
    // ----- return  ----- Branching.ssc(49,51)
    k$out := k;
    $result := stack0b;
    return;
