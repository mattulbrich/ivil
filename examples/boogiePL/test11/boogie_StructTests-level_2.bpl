...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /level:2 StructTests.dll
...
axiom (forall this: struct :: 0 <= cast($StructGet(this, St.x),int));
...
{
  var this: struct where true, throwException: bool where true, return.value: bool where true, SS$Display.Return.Local: bool where true, stack0b: bool;
...
procedure St..ctor$System.Int32(this$in: struct, y$in: int where InRange(y$in, System.Int32)) returns (this$out: struct);
  ...
  ensures cast($StructGet(this$out, St.x),int) == y$in;
  // newly allocated objects are fully valid
  free ensures (forall $o: ref :: $o != null && old($Heap)[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
  // first consistent owner unchanged if its exposeVersion is
  free ensures (forall $o: ref :: { $Heap[$o, $FirstConsistentOwner] } old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] ==> old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner]);
...
{
  var this: struct where true, y: int where InRange(y, System.Int32);
  ...
  block1666:
    // ----- nop
    // ----- store field  ----- StructTests.ssc(14,5)
    this := $StructSet(this, St.x, y);
    assume IsHeap($Heap);
    goto block1768;
...
{
  var this: struct where true, b: bool where true, stack1b: bool, stack1i: int;
  ...
  block2108:
    // ----- copy  ----- StructTests.ssc(19,5)
    stack1b := b;
    // ----- unary operator  ----- StructTests.ssc(19,5)
    // ----- branch  ----- StructTests.ssc(19,5)
    goto true2108to2142, false2108to2125;
  ...
  block2159:
    // ----- store field
    this := $StructSet(this, St.x, stack1i);
    assume IsHeap($Heap);
    // ----- return  ----- StructTests.ssc(20,3)
    this$out := this;
    return;
...
procedure St.M$System.Int32.array$notnull(this$in: struct, a$in: ref where $IsNotNull(a$in, ValueArray(System.Int32, 1))) returns (this$out: struct);
  ...
  // user-declared preconditions
  requires 0 <= cast($StructGet(this$in, St.x),int) && cast($StructGet(this$in, St.x),int) < $Length(a$in);
  ...
  modifies $Heap;
  // user-declared postconditions
  ensures old(cast($StructGet(this$in, St.x),int)) < cast($StructGet(this$out, St.x),int);
  // newly allocated objects are fully valid
  free ensures (forall $o: ref :: $o != null && old($Heap)[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
  // first consistent owner unchanged if its exposeVersion is
  free ensures (forall $o: ref :: { $Heap[$o, $FirstConsistentOwner] } old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] ==> old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner]);
...
{
  var this: struct where true, a: ref where $IsNotNull(a, ValueArray(System.Int32, 1)), stack0o: ref, stack1i: int, inc: int where InRange(inc, System.Int32), stack0i: int, stack0b: bool;
  ...
  block3910:
    // ----- nop
    // ----- copy  ----- StructTests.ssc(27,5)
    stack0o := a;
    // ----- load field  ----- StructTests.ssc(27,5)
    stack1i := cast($StructGet(this, St.x),int);
    // ----- load element  ----- StructTests.ssc(27,5)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
    inc := cast(ValueArrayGet($Heap[stack0o, $elements], stack1i),int);
    // ----- load constant 0  ----- StructTests.ssc(28,5)
    stack0i := 0;
    // ----- binary operator  ----- StructTests.ssc(28,5)
    // ----- branch  ----- StructTests.ssc(28,5)
    goto true3910to3944, false3910to3927;
  ...
  block3944:
    // ----- load field  ----- StructTests.ssc(31,5)
    stack0i := cast($StructGet(this, St.x),int);
    // ----- binary operator  ----- StructTests.ssc(31,5)
    stack0i := stack0i + inc;
    // ----- store field  ----- StructTests.ssc(31,5)
    this := $StructSet(this, St.x, stack0i);
    assume IsHeap($Heap);
    goto block4046;

  block3927:
    // ----- load constant 1  ----- StructTests.ssc(29,7)
    inc := 1;
    goto block3944;
...
{
  var this: struct where true, stack0i: int, stack1i: int;
  ...
  block4488:
    // ----- load constant 1  ----- StructTests.ssc(38,5)
    stack0i := 1;
    // ----- load field  ----- StructTests.ssc(38,5)
    stack1i := cast($StructGet(this, St.x),int);
    // ----- binary operator  ----- StructTests.ssc(38,5)
    stack0i := stack0i + stack1i;
    // ----- load constant 1  ----- StructTests.ssc(38,5)
    stack1i := 1;
    // ----- binary operator  ----- StructTests.ssc(38,5)
    stack0i := stack0i - stack1i;
    // ----- store field  ----- StructTests.ssc(38,5)
    this := $StructSet(this, St.x, stack0i);
    assume IsHeap($Heap);
    // ----- return  ----- StructTests.ssc(39,3)
    this$out := this;
    return;
...
{
  var this: struct where true, stack0o: ref;
  ...
  block4845:
    // ----- serialized AssertStatement  ----- StructTests.ssc(43,5)
    assert 0 <= cast($StructGet(this, St.x),int);
    goto block4930;

  block4930:
    // ----- nop
    // ----- return  ----- StructTests.ssc(44,3)
    this$out := this;
    return;
...
{
  var this: struct where true, stack0i: int, stack0o: ref;
  ...
  block5270:
    // ----- load constant -2  ----- StructTests.ssc(48,5)
    stack0i := -2;
    // ----- store field  ----- StructTests.ssc(48,5)
    this := $StructSet(this, St.x, stack0i);
    assume IsHeap($Heap);
    // ----- serialized AssertStatement  ----- StructTests.ssc(49,5)
    assert 0 <= cast($StructGet(this, St.x),int);
    goto block5355;

  block5355:
    // ----- nop
    // ----- return  ----- StructTests.ssc(50,3)
    this$out := this;
    return;
...
{
  var this: struct where true, stack0i: int;
  ...
  block5644:
    // ----- load constant -2  ----- StructTests.ssc(54,5)
    stack0i := -2;
    // ----- store field  ----- StructTests.ssc(54,5)
    this := $StructSet(this, St.x, stack0i);
    assume IsHeap($Heap);
    // ----- return  ----- StructTests.ssc(55,3)
    this$out := this;
    return;
...
{
  var this: struct where true, y: int where InRange(y, System.Int32), z: int where InRange(z, System.Int32), stack1i: int, stack0o: ref;
  ...
  block5933:
    // ----- load indirect  ----- StructTests.ssc(58,5)
    stack1i := y;
    // ----- store indirect  ----- StructTests.ssc(58,5)
    z := stack1i;
    // ----- serialized AssertStatement  ----- StructTests.ssc(59,5)
    assert cast($StructGet(this, St.x),int) == 8;
    goto block6018;

  block6018:
    // ----- nop
    // ----- return  ----- StructTests.ssc(60,3)
    this$out := this;
    y$out := y;
    z$out := z;
    return;
