 ...
 * @author Timm Felden
 */
public class AnyFieldExpression extends Expression {
    
    public AnyFieldExpression() {
    }

    public AnyFieldExpression(int beginLine, int beginColumn, int endLine, int endColumn) {
