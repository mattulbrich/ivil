...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Ensures
...
implementation Test.FooGood() returns ($result: int)
{
  ...
  block2737:
    // ----- load constant 1  ----- Ensures.ssc(6,9)
    return.value := 1;
    // ----- branch
    goto block2754;
  ...
  block2975:
    ...
    // ----- copy  ----- Ensures.ssc(7,5)
    stack0i := return.value;
    // ----- return  ----- Ensures.ssc(7,5)
    $result := stack0i;
    return;
...
implementation Test.FooBad() returns ($result: int)
{
  ...
  block3468:
    // ----- load constant 2  ----- Ensures.ssc(12,9)
    return.value := 2;
    // ----- branch
    goto block3485;
  ...
  block3706:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- Ensures.ssc(13,5)
    stack0i := return.value;
    // ----- return  ----- Ensures.ssc(13,5)
    $result := stack0i;
    return;
