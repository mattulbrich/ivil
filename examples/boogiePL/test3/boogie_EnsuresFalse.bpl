...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify EnsuresFalse.dll
...
implementation C.foo(this: ref) returns ($result: int)
{
  ...
  block1309:
    // ----- load constant "foo"  ----- EnsuresFalse.ssc(6,5)
    stack0o := $stringLiteral0;
    // ----- call  ----- EnsuresFalse.ssc(6,5)
