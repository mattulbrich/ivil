...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Cast
...
{
  var o: ref where $Is(o, System.Object), stack0o: ref, a: ref where $Is(a, RefArray(System.Object, 1)), return.value: ref where $Is(return.value, RefArray(System.Object, 1)), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, RefArray(System.Object, 1));

  entry:
    assume $IsNotNull(this, Cast);
  ...
  block4148:
    // ----- serialized AssumeStatement  ----- Cast.ssc(3,5)
    assume o != null;
    goto block4301;
  ...
  block4318:
    // ----- castclass  ----- Cast.ssc(4,18)
    assert $Is(o, RefArray(System.Object, 1));
    stack0o := o;
    // ----- copy  ----- Cast.ssc(4,5)
    a := stack0o;
    goto block4335;
...
{
  var o: ref where $Is(o, System.Object), stack0o: ref, stack0b: bool, s: ref where $Is(s, System.String), return.value: ref where $Is(return.value, System.Object), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.Object);
  ...
  block4828:
    // ----- castclass  ----- Cast.ssc(10,18)
    assert $Is(o, System.String);
    stack0o := o;
    // ----- copy  ----- Cast.ssc(10,7)
    s := stack0o;
    goto block4845;
...
{
  var s0: ref where $Is(s0, System.String), s1: ref where $IsNotNull(s1, System.String), s2: ref where $Is(s2, System.String), o: ref where $Is(o, System.Object), stack0o: ref, s: ref where $Is(s, System.String), return.value: ref where $Is(return.value, System.String), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.String);
  ...
  block5695:
    // ----- load constant "hello"  ----- Cast.ssc(17,5)
    s2 := $stringLiteral1;
    goto block5712;
...
{
  var s0: ref where $Is(s0, System.String), cc: ref where $Is(cc, ValueArray(System.Char, 1)), s1: ref where $Is(s1, System.String), stack0o: ref, stack50000o: ref, s2: ref where $Is(s2, System.String), o2: ref where $Is(o2, System.Object);
  ...
  block6834:
    // ----- load constant "hello"  ----- Cast.ssc(32,5)
    s1 := $stringLiteral1;
    goto block6851;
  ...
  block6851:
    // ----- copy  ----- Cast.ssc(33,28)
    stack0o := cc;
    // ----- new object  ----- Cast.ssc(33,17)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == System.String;
    ...
    call System.String..ctor$System.Char.array(stack50000o, stack0o);
    // ----- copy  ----- Cast.ssc(33,5)
    stack0o := stack50000o;
    // ----- copy  ----- Cast.ssc(33,5)
    s2 := stack0o;
  ...
  block6885:
    // ----- serialized AssertStatement  ----- Cast.ssc(35,5)
    assert s0 != o2;
    goto block7038;
  ...
  block7055:
    // ----- serialized AssertStatement  ----- Cast.ssc(36,5)
    assert s1 != o2;
    goto block7208;
  ...
  block7225:
    // ----- serialized AssertStatement  ----- Cast.ssc(37,5)
    assert s1 != null;
    goto block7378;
  ...
  block7395:
    // ----- serialized AssertStatement  ----- Cast.ssc(38,5)
    assert s2 != null;
    goto block7548;
...
{
  var s0: ref where $Is(s0, System.String), s1: ref where $Is(s1, System.String), o0: ref where $Is(o0, System.Object), o1: ref where $Is(o1, System.Object), stack0o: ref, return.value: ref where $Is(return.value, System.String), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.String);
  ...
  block8194:
    // ----- load constant "hello"  ----- Cast.ssc(42,5)
    s1 := $stringLiteral1;
    goto block8211;
  ...
  block8245:
    // ----- serialized AssertStatement  ----- Cast.ssc(45,5)
    assert o0 != o1;
    goto block8398;
...
{
  var o: ref where $Is(o, System.Object), choice: int where InRange(choice, System.Int32), stack0i: int, stack0b: bool, stack0o: ref, s: ref where $Is(s, System.String), a: ref where $Is(a, RefArray(System.Object, 1)), j: ref where $Is(j, J), return.value: ref where $Is(return.value, System.Object), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.Object);
  ...
  block9418:
    // ----- load constant 0  ----- Cast.ssc(52,19)
    stack0i := 0;
    // ----- binary operator  ----- Cast.ssc(52,9)
    // ----- branch  ----- Cast.ssc(52,5)
    goto true9418to9486, false9418to9435;

  true9418to9486:
    assume choice != stack0i;
    goto block9486;
  ...
  block9486:
    // ----- load constant 1  ----- Cast.ssc(55,26)
    stack0i := 1;
    // ----- binary operator  ----- Cast.ssc(55,16)
    // ----- branch  ----- Cast.ssc(55,12)
    goto true9486to9554, false9486to9503;

  block9435:
    // ----- castclass  ----- Cast.ssc(53,18)
    assert $Is(o, System.String);
    stack0o := o;
    // ----- copy  ----- Cast.ssc(53,7)
    s := stack0o;
...
implementation Cast..ctor(this: ref)
{
  ...
  block10013:
    ...
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Cast ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Cast;
    assume IsHeap($Heap);
    return;
...
axiom (forall heap: [ref,<x>name]x :: { heap[$stringLiteral1, $allocated] } IsHeap(heap) ==> heap[$stringLiteral1, $allocated]) && $IsNotNull($stringLiteral1, System.String) && $StringLength($stringLiteral1) == 5;
