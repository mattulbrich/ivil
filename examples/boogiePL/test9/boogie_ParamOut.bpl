...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify ParamOut.dll
...
{
  var bar: ref where $IsNotNull(bar, MyInterface`2...System.String`~`System.String), stack0o: ref, stack1o: ref, stack0b: bool, s: ref where $Is(s, System.String), stack0i: int;
  ...
  block2346:
    // ----- nop
    // ----- load constant "abc"  ----- ParamOut.ssc(13,5)
    stack0o := $stringLiteral0;
    // ----- load address  ----- ParamOut.ssc(13,5)
    havoc stack1o;
    // ----- call  ----- ParamOut.ssc(13,5)
    assert bar != null;
    call stack0b, s := MyInterface`2...System.String`~`System.String.TryGetValue$System.String$System.String.ptr$.Virtual.$(bar, stack0o);
    // ----- branch (no expression improvement)  ----- ParamOut.ssc(13,5)
    goto true2346to2380, false2346to2363;
  ...
  block2380:
    // ----- copy  ----- ParamOut.ssc(16,5)
    stack0o := s;
    assert stack0o != null;
    stack0o := stack0o;
    // ----- string length  ----- ParamOut.ssc(16,5)
    assert stack0o != null;
    stack0i := $StringLength(stack0o);
    // ----- call  ----- ParamOut.ssc(16,5)
    call System.Console.WriteLine$System.Int32(stack0i);
    // ----- return
    return;

  block2363:
    // ----- load constant "def"  ----- ParamOut.ssc(14,7)
    s := $stringLiteral1;
    goto block2380;
