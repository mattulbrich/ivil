...
//
//public class CodeVisitor extends DefaultAlgoParserVisitor {
//
...
//
//    public CodeVisitor(ParsedData parsedData, boolean refinementMode) {
//        this.parsedData = parsedData;
//        this.refinementMode = refinementMode;
//        this.termVisitor = new TermVisitor(parsedData, statements);
//    }
//
...
//                    parsedData.addVariableSymbol(string, val, mode);
//                }
//                identifiers.clear();
//            }
//        }
...
//            String markInvariant = parsedData.getCouplingInvariant(markPoint);
//            String markVariant = parsedData.getCouplingVariant(markPoint);
