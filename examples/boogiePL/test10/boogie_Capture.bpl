...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Capture.dll
...
{
  var stack50000o: ref, stack0o: ref, c: ref where $Is(c, Capture);
  ...
  block1904:
    // ----- new object  ----- Capture.ssc(7,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Capture;
    ...
    // ----- call  ----- Capture.ssc(7,5)
    assert stack50000o != null;
    call Capture..ctor(stack50000o);
    // ----- copy  ----- Capture.ssc(7,5)
    stack0o := stack50000o;
    // ----- copy  ----- Capture.ssc(7,5)
    c := stack0o;
    // ----- copy  ----- Capture.ssc(8,5)
    stack0o := c;
    assert stack0o != null;
    stack0o := stack0o;
    // ----- call  ----- Capture.ssc(8,5)
    assert this != null;
    call Capture.Foo$System.Object$notnull(this, stack0o);
    // ----- return  ----- Capture.ssc(9,3)
    return;
...
{
  var o: ref where $IsNotNull(o, System.Object), stack0o: ref;
  ...
  block2448:
    // ----- nop
    // ----- serialized AssumeStatement  ----- Capture.ssc(12,5)
    assume $Heap[o, $ownerFrame] == $PeerGroupPlaceholder;
    goto block2533;

  block2533:
    // ----- nop
    // ----- copy  ----- Capture.ssc(13,5)
    stack0o := o;
    // ----- call  ----- Capture.ssc(13,5)
    assert this != null;
    call Capture.Foo$System.Object$notnull(this, stack0o);
    // ----- return
    return;
...
implementation Capture.Caller2$System.Object$notnull(this: ref, o$in: ref)
{
  ...
  block3128:
    // ----- nop
    // ----- serialized AssumeStatement  ----- Capture.ssc(19,5)
    assume $Heap[o, $ownerFrame] == $PeerGroupPlaceholder;
    goto block3213;

  block3213:
    // ----- nop
    // ----- copy  ----- Capture.ssc(20,5)
    stack0o := o;
    // ----- call  ----- Capture.ssc(20,5)
    assert this != null;
    call Capture.Foo$System.Object$notnull(this, stack0o);
    // ----- return
    return;
...
implementation Capture.Caller3$System.Object$notnull(this: ref, o$in: ref)
{
  ...
  block3808:
    // ----- nop
    // ----- serialized AssumeStatement  ----- Capture.ssc(24,5)
    assume $Heap[o, $ownerFrame] == $PeerGroupPlaceholder;
    goto block3893;

  block3893:
    // ----- nop
    // ----- copy  ----- Capture.ssc(25,5)
    stack0o := o;
    // ----- call  ----- Capture.ssc(25,5)
    assert this != null;
    call Capture.Foo$System.Object$notnull(this, stack0o);
    // ----- return
    return;
...
implementation Capture..ctor(this: ref)
{
  ...
  block4233:
    // ----- call  ----- Capture.ssc(3,14)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Capture ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Capture;
    assume IsHeap($Heap);
    return;
