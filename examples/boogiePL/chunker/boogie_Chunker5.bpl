...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker5
...
axiom (forall $oi: ref, $h: [ref,<x>name]x :: { $h[$oi, $inv] <: Chunker } IsHeap($h) && $h[$oi, $inv] <: Chunker && $h[$oi, $localinv] != System.Object ==> 0 <= $h[$oi, Chunker.n]);
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3383:
    // ----- load constant 0  ----- Chunker5.ssc(6,13)
    stack0i := 0;
    // ----- load field  ----- Chunker5.ssc(6,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker5.ssc(6,13)
    // ----- branch
    goto true3383to3502, false3383to3400;
  ...
  block3400:
    ...
    // ----- unary operator
    // ----- branch
    goto true3400to3451, false3400to3417;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block5865:
    // ----- store field  ----- Chunker5.ssc(18,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker5.ssc(19,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker5.ssc(20,9)
    stack0i := 0;
    // ----- store field  ----- Chunker5.ssc(20,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block6052:
    // ----- FrameGuard processing  ----- Chunker5.ssc(22,3)
    temp1 := this;
    // ----- classic pack  ----- Chunker5.ssc(22,3)
    assert temp1 != null;
