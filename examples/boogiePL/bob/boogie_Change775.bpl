...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Change775
...
implementation S.Foo(this$in: struct) returns ($result: bool)
{
  ...
  block2482:
    // ----- load constant True  ----- Change775.ssc(2,52)
    return.value := true;
    // ----- branch
    goto block2499;
  ...
  block2516:
    ...
    // ----- copy  ----- Change775.ssc(2,64)
    stack0b := return.value;
    // ----- return  ----- Change775.ssc(2,64)
    $result := stack0b;
    return;
