 ...
 */
public class JMLParserTestCreator {
    ...
    private static void append(final BufferedWriter out, final String path, final String pattern) throws IOException {
        File f;
        if (path.endsWith(".java") || path.endsWith(".jml")) {
    ...
    public static void main(String[] args) {
        final String PATH = "test/de/uka/iti/pseudo/jml/GenTest";
        ...
        try {
            ...
            for (String context : new File(DATA).list()) {
                ...
                out.write("package de.uka.iti.pseudo.jml;\n" + "import junit.framework.TestCase;\n"
                        + "public class GenTest" + context + " extends TestCase {\n\n");
