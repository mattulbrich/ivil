...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo ManualRange2
...
const Tools.Range_Enumerator.Values: <struct>name;
...
function #SeqOfInt.get_Count(struct) returns (int);

axiom (forall this: struct :: 0 <= #SeqOfInt.get_Count(this));

function #Tools.Range_Enumerable.a(ref) returns (int);

axiom (forall $r: ref :: InRange(#Tools.Range_Enumerable.a($r), System.Int32));

function #Tools.Range_Enumerable.b(ref) returns (int);

axiom (forall $r: ref :: InRange(#Tools.Range_Enumerable.b($r), System.Int32));

function #SeqOfInt.get_Item$System.Int32(struct, int) returns (int);

function #Tools.Range_Enumerator.a(ref) returns (int);

axiom (forall $r: ref :: InRange(#Tools.Range_Enumerator.a($r), System.Int32));

function #Tools.Range_Enumerator.b(ref) returns (int);
...
axiom (forall $oi: ref, $h: [ref,<x>name]x :: { $h[$oi, $inv] <: Tools.Range_Enumerable } IsHeap($h) && $h[$oi, $inv] <: Tools.Range_Enumerable && $h[$oi, $localinv] != System.Object ==> #Tools.Range_Enumerable.a($oi) <= #Tools.Range_Enumerable.b($oi));
...
{
  var a: int where InRange(a, System.Int32), b: int where InRange(b, System.Int32), stack0o: ref, temp0: struct, values: struct where true, x: int where InRange(x, System.Int32), stack0b: bool, stack1i: int, local28560: int where InRange(local28560, System.Int32), stack0i: int, $Heap$block26571$LoopPreheader: [ref,<x>name]x;
  ...
  block25738:
    // ----- load address  ----- ManualRange2.ssc(157,7)
    havoc stack0o;
    // ----- initobj  ----- ManualRange2.ssc(157,7)
    havoc temp0;
    assume ZeroInit(temp0, SeqOfInt);
    values := temp0;
    goto block25755;

  block25755:
    // ----- serialized AssumeStatement  ----- ManualRange2.ssc(158,7)
    assume #SeqOfInt.get_Count(values) == 0;
    goto block25908;
  ...
  block25925:
    // ----- serialized AssertStatement  ----- ManualRange2.ssc(159,7)
    assert #SeqOfInt.get_Count(values) <= b - a;
    goto block26078;
  ...
  block26095:
    // ----- serialized AssertStatement  ----- ManualRange2.ssc(160,7)
    assert (forall ^i: int :: 0 <= ^i && ^i <= #SeqOfInt.get_Count(values) - 1 ==> #SeqOfInt.get_Item$System.Int32(values, ^i) == a + ^i);
    goto block26537;
  ...
  block26554:
    // ----- copy  ----- ManualRange2.ssc(162,12)
    x := a;
    goto block26571$LoopPreheader;

  block26571:
    // ----- default loop invariant: allocation and ownership are stable  ----- ManualRange2.ssc(163,20)
    assume (forall $o: ref :: $Heap$block26571$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block26571$LoopPreheader[$ot, $allocated] == true && $Heap$block26571$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block26571$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block26571$LoopPreheader[$ot, $ownerFrame]) && $Heap$block26571$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- ManualRange2.ssc(163,20)
    assume (forall $o: ref :: ($Heap$block26571$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block26571$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block26571$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block26571$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- ManualRange2.ssc(163,20)
    assert (forall $o: ref :: $o != null && $Heap$block26571$LoopPreheader[$o, $allocated] == true ==> $Heap$block26571$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block26571$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- serialized LoopInvariant  ----- ManualRange2.ssc(163,20)
    assert #SeqOfInt.get_Count(values) <= b - a;
    // ----- serialized LoopInvariant  ----- ManualRange2.ssc(164,20)
    assert (forall ^i: int :: 0 <= ^i && ^i <= #SeqOfInt.get_Count(values) - 1 ==> #SeqOfInt.get_Item$System.Int32(values, ^i) == a + ^i);
    // ----- serialized LoopInvariant  ----- ManualRange2.ssc(165,20)
    assert x == a + #SeqOfInt.get_Count(values);
    goto block27115;
  ...
  block27132:
    // ----- binary operator  ----- ManualRange2.ssc(162,23)
    // ----- branch  ----- ManualRange2.ssc(162,23)
    goto true27132to27846, false27132to27149;
  ...
  block27149:
    // ----- load address  ----- ManualRange2.ssc(167,10)
    havoc stack0o;
    // ----- copy  ----- ManualRange2.ssc(167,21)
    stack1i := x;
    // ----- call  ----- ManualRange2.ssc(167,10)
    call values := SeqOfInt.Add$System.Int32(values, stack1i);
    goto block27166;

  block27166:
    // ----- serialized AssertStatement  ----- ManualRange2.ssc(168,10)
    assert #SeqOfInt.get_Count(values) <= b - a;
    goto block27319;

  block27863:
    // ----- serialized AssertStatement  ----- ManualRange2.ssc(172,7)
    assert #SeqOfInt.get_Count(values) == b - a;
    goto block28016;
  ...
  block27336:
    // ----- serialized AssertStatement  ----- ManualRange2.ssc(169,10)
    assert (forall ^i: int :: 0 <= ^i && ^i <= #SeqOfInt.get_Count(values) - 1 ==> #SeqOfInt.get_Item$System.Int32(values, ^i) == a + ^i);
    goto block27778;
  ...
  block27795:
    // ----- copy  ----- ManualRange2.ssc(162,30)
    local28560 := x;
    // ----- load constant 1  ----- ManualRange2.ssc(162,30)
    stack0i := 1;
    // ----- binary operator  ----- ManualRange2.ssc(162,30)
    stack0i := local28560 + stack0i;
    // ----- copy  ----- ManualRange2.ssc(162,30)
    x := stack0i;
    // ----- copy  ----- ManualRange2.ssc(162,30)
    stack0i := local28560;
  ...
  block26571$LoopPreheader:
    $Heap$block26571$LoopPreheader := $Heap;
    goto block26571;
...
procedure SeqOfInt.Add$System.Int32(this$in: struct, value$in: int where InRange(value$in, System.Int32)) returns (this$out: struct);
  ...
  ensures (forall ^i: int :: 0 <= ^i && ^i <= #SeqOfInt.get_Count(this$out) - 1 ==> #SeqOfInt.get_Item$System.Int32(this$out, ^i) == cast($IfThenElse(^i == #SeqOfInt.get_Count(this$out) - 1, value$in, #SeqOfInt.get_Item$System.Int32(old(this$in), ^i)),int));
  // newly allocated objects are fully valid
  free ensures (forall $o: ref :: $o != null && old($Heap)[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
  // first consistent owner unchanged if its exposeVersion is
  free ensures (forall $o: ref :: { $Heap[$o, $FirstConsistentOwner] } old($Heap)[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] == $Heap[old($Heap)[$o, $FirstConsistentOwner], $exposeVersion] ==> old($Heap)[$o, $FirstConsistentOwner] == $Heap[$o, $FirstConsistentOwner]);
...
{
  var sum: int where InRange(sum, System.Int32), stack0i: int, stack1i: int, c: ref where $IsNotNull(c, Tools.Range_Enumerable), e: ref where $IsNotNull(e, Tools.Range_Enumerator), stack0o: ref, stack0b: bool, $Heap$block29580$LoopPreheader: [ref,<x>name]x;
  ...
  block29529:
    // ----- load constant 0  ----- ManualRange2.ssc(180,7)
    sum := 0;
    goto block29546;

  block29546:
    // ----- load constant 1  ----- ManualRange2.ssc(181,47)
    stack0i := 1;
    // ----- load constant 3  ----- ManualRange2.ssc(181,50)
    stack1i := 3;
    // ----- call  ----- ManualRange2.ssc(181,7)
    call c := Tools.Range$System.Int32$System.Int32(stack0i, stack1i);
    goto block29563;

  block29563:
    // ----- call  ----- ManualRange2.ssc(182,7)
    assert c != null;
    call e := Tools.Range_Enumerable.GetEnumerator(c);
    goto block29580$LoopPreheader;

  block29580:
    // ----- default loop invariant: allocation and ownership are stable  ----- ManualRange2.ssc(184,20)
    assume (forall $o: ref :: $Heap$block29580$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block29580$LoopPreheader[$ot, $allocated] == true && $Heap$block29580$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block29580$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block29580$LoopPreheader[$ot, $ownerFrame]) && $Heap$block29580$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- ManualRange2.ssc(184,20)
    assume (forall $o: ref :: ($Heap$block29580$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block29580$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block29580$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block29580$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- ManualRange2.ssc(184,20)
    assert (forall $o: ref :: $o != null && $Heap$block29580$LoopPreheader[$o, $allocated] == true ==> $Heap$block29580$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block29580$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- serialized LoopInvariant  ----- ManualRange2.ssc(184,20)
    assert #SeqOfInt.get_Count($Heap[e, Tools.Range_Enumerator.Values]) == 0 ==> sum == 0;
    // ----- serialized LoopInvariant  ----- ManualRange2.ssc(185,20)
    assert #SeqOfInt.get_Count($Heap[e, Tools.Range_Enumerator.Values]) == 1 ==> sum == 1;
    // ----- serialized LoopInvariant  ----- ManualRange2.ssc(186,20)
    assert #SeqOfInt.get_Count($Heap[e, Tools.Range_Enumerator.Values]) == 2 ==> sum == 3;
    // ----- serialized LoopInvariant  ----- ManualRange2.ssc(187,22)
  ...
  block30413:
    // ----- call  ----- ManualRange2.ssc(183,14)
    assert e != null;
    call stack0b := Tools.Range_Enumerator.MoveNext(e);
    // ----- unary operator  ----- ManualRange2.ssc(183,14)
    // ----- branch  ----- ManualRange2.ssc(183,7)
    goto true30413to30464, false30413to30430;
  ...
  block30430:
    // ----- call  ----- ManualRange2.ssc(189,17)
    assert e != null;
    call stack0i := Tools.Range_Enumerator.get_Current(e);
    // ----- binary operator  ----- ManualRange2.ssc(189,10)
    stack0i := sum + stack0i;
    // ----- copy  ----- ManualRange2.ssc(189,10)
    sum := stack0i;
    goto block30447;

  block30447:
    // ----- branch  ----- ManualRange2.ssc(190,8)
    goto block29580;

  block30481:
    // ----- serialized AssertStatement  ----- ManualRange2.ssc(191,7)
    assert sum == 3;
    goto block30634;
  ...
  block30668:
    // ----- return  ----- ManualRange2.ssc(192,4)
    return;

  block29580$LoopPreheader:
    $Heap$block29580$LoopPreheader := $Heap;
    goto block29580;
...
axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #Tools.Range_Enumerator.get_Current($Heap, this) } IsHeap($Heap) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[this, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc)) ==> InRange(#Tools.Range_Enumerator.get_Current($Heap, this), System.Int32));
