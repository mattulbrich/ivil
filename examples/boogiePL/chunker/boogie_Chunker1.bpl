...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker1
...
{
  var stack0o: ref, stack1i: int, stack2i: int, s: ref where $Is(s, System.String), stack0i: int, temp0: exposeVersionType, return.value: ref where $Is(return.value, System.String), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.String);
  ...
  block2839:
    ...
    // ----- copy  ----- Chunker1.ssc(12,3)
    stack0o := return.value;
    // ----- return  ----- Chunker1.ssc(12,3)
    $result := stack0o;
    return;
...
{
  var source: ref where $Is(source, System.String), chunkSize: int where InRange(chunkSize, System.Int32), stack0o: ref, temp0: exposeVersionType, temp1: exposeVersionType, stack0i: int, temp2: exposeVersionType;
  ...
  block3247:
    // ----- call  ----- Chunker1.ssc(15,3)
    assert this != null;
    call System.Object..ctor(this);
    goto block3264;

  block3264:
    // ----- copy  ----- Chunker1.ssc(16,11)
    stack0o := source;
    assert stack0o != null;
    stack0o := stack0o;
    // ----- store field  ----- Chunker1.ssc(16,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Chunker.src] := stack0o;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker1.ssc(17,5)
    assert this != null;
    havoc temp1;
    $Heap[this, $exposeVersion] := temp1;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker1.ssc(18,9)
    stack0i := 0;
    // ----- store field  ----- Chunker1.ssc(18,5)
    assert this != null;
    havoc temp2;
  ...
  block3298:
    // ----- return  ----- Chunker1.ssc(19,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Chunker ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Chunker;
    assume IsHeap($Heap);
    return;
