...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleWhile4.dll /infer:i
...
{
  var i: int where InRange(i, System.Int32), count: int where InRange(count, System.Int32), stack0i: int, stack0b: bool, local2: int where InRange(local2, System.Int32), local3: int where InRange(local3, System.Int32), stack0o: ref, local4: int where InRange(local4, System.Int32), local5: int where InRange(local5, System.Int32), $Heap$block1343$LoopPreheader: [ref,<x>name]x;

  entry:
    assume $IsNotNull(this, SimpleWhile4);
  ...
  block1309:
    // ----- load constant 30  ----- SimpleWhile4.ssc(6,3)
    i := 30;
    // ----- load constant 0  ----- SimpleWhile4.ssc(7,3)
    count := 0;
    // ----- load constant 0  ----- SimpleWhile4.ssc(9,3)
    stack0i := 0;
    // ----- binary operator  ----- SimpleWhile4.ssc(9,3)
    // ----- branch  ----- SimpleWhile4.ssc(9,3)
    goto true1309to1343, false1309to1326;

  true1309to1343:
    assume i <= stack0i;
    goto block1343$LoopPreheader;
  ...
  block1343:
    // ----- default loop invariant: allocation and ownership are stable  ----- SimpleWhile4.ssc(13,3)
    assume (forall $o: ref :: $Heap$block1343$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block1343$LoopPreheader[$ot, $allocated] == true && $Heap$block1343$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block1343$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block1343$LoopPreheader[$ot, $ownerFrame]) && $Heap$block1343$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- SimpleWhile4.ssc(13,3)
    assume (forall $o: ref :: ($Heap$block1343$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block1343$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block1343$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block1343$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- SimpleWhile4.ssc(13,3)
    assert (forall $o: ref :: $o != null && $Heap$block1343$LoopPreheader[$o, $allocated] == true ==> $Heap$block1343$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block1343$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 0  ----- SimpleWhile4.ssc(13,3)
    stack0i := 0;
    // ----- binary operator  ----- SimpleWhile4.ssc(13,3)
    // ----- branch  ----- SimpleWhile4.ssc(13,3)
    goto true1343to1377, false1343to1360;

  block1326:
    // ----- copy  ----- SimpleWhile4.ssc(10,4)
    local2 := i;
    // ----- load constant 1  ----- SimpleWhile4.ssc(10,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile4.ssc(10,4)
    stack0i := local2 - stack0i;
    // ----- copy  ----- SimpleWhile4.ssc(10,4)
    i := stack0i;
    // ----- copy
    stack0i := local2;
    // ----- copy  ----- SimpleWhile4.ssc(11,4)
    local3 := count;
    // ----- load constant 1  ----- SimpleWhile4.ssc(11,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile4.ssc(11,4)
  ...
  block1377:
    // ----- serialized AssertStatement  ----- SimpleWhile4.ssc(19,3)
    assert count < 0;
    goto block1462;

  block1360:
    // ----- copy  ----- SimpleWhile4.ssc(15,4)
    local4 := i;
    // ----- load constant 1  ----- SimpleWhile4.ssc(15,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile4.ssc(15,4)
    stack0i := local4 - stack0i;
    // ----- copy  ----- SimpleWhile4.ssc(15,4)
    i := stack0i;
    // ----- copy
    stack0i := local4;
    // ----- copy  ----- SimpleWhile4.ssc(16,4)
    local5 := count;
    // ----- load constant 1  ----- SimpleWhile4.ssc(16,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile4.ssc(16,4)
    stack0i := local5 - stack0i;
    // ----- copy  ----- SimpleWhile4.ssc(16,4)
    count := stack0i;
    // ----- copy
    stack0i := local5;
    // ----- branch  ----- SimpleWhile4.ssc(17,4)
    goto block1343;

  block1462:
    // ----- nop
    // ----- return  ----- SimpleWhile4.ssc(21,2)
    return;

  block1343$LoopPreheader:
    $Heap$block1343$LoopPreheader := $Heap;
    goto block1343;
...
implementation SimpleWhile4..ctor(this: ref)
{
  ...
  block2193:
    // ----- call  ----- SimpleWhile4.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleWhile4 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleWhile4;
    assume IsHeap($Heap);
    return;
