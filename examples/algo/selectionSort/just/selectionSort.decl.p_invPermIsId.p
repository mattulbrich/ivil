...
rule isSorted_def
  ...
  where freshVar %i as int, %a as seq(int)
  where freshVar %j as int, %a as seq(int)
  samegoal
...
rule getOfSwap
  find seqGet(seqSwap(%a as seq(%'v12),%i as int,%j as int) as seq(%'v12),%k as int) as %'v12
  samegoal
    replace cond($and($lte(0 as int,%k as int) as bool,$lt(%k as int,seqLen(%a as seq(%'v12)) as int) as bool) as bool,cond($eq(%i as int,%k as int) as bool,seqGet(%a as seq(%'v12),%j as int) as %'v12,cond($eq(%j as int,%k as int) as bool,seqGet(%a as seq(%'v12),%i as int) as %'v12,seqGet(%a as seq(%'v12),%k as int) as %'v12) as %'v12) as %'v12,seqError as %'v12) as %'v12
  tags
    rewrite "fol simp"
    asAxiom ""
    derived ""
...
rule lenOfSwap
  find seqLen(seqSwap(%a as seq(%'v2),%i as int,%j as int) as seq(%'v2)) as int
  samegoal
    replace seqLen(%a as seq(%'v2)) as int
  tags
    rewrite "fol simp"
    asAxiom ""
    derived ""
...
rule inDomSwap
  find seqDom(seqSwap(%a as seq(%'v2),%i as int,%j as int) as seq(%'v2),%k as int) as bool
  samegoal
    replace seqDom(%a as seq(%'v2),%k as int) as bool
  tags
    rewrite "fol simp"
    derived ""

rule inDomId
  find seqDom(seqId(%n as int) as seq(int),%i as int) as bool
  samegoal
    replace $and($lte(0 as int,%i as int) as bool,$lt(%i as int,%n as int) as bool) as bool
  tags
    rewrite "fol simp"
    derived ""
...
rule isPermN_read_preserves_inDom
  ...
  assume isPermN(%x) |-
  samegoal
    replace seqDom(%x as seq(int),%i as int) as bool
  tags
    derived ""
...
rule isPermN_swap
  ...
  samegoal
    replace $and($and(isPermN(%a as seq(int)) as bool,seqDom(%a as seq(int),%i as int) as bool) as bool,seqDom(%a as seq(int),%j as int) as bool) as bool
  tags
    derived ""

rule isPermN_id
  find isPermN(seqId(%n as int) as seq(int)) as bool
  samegoal
    replace true as bool
  tags
    rewrite "concrete"
    derived ""
...
rule isPerm_trans
  ...
  assume isPerm(%a,%b) |-
  samegoal
    add isPerm(%a as seq(%'v1),%c as seq(%'v1)) as bool |-
  tags
    asAxiom ""
    derived ""

rule isPerm_symm
  find isPerm(%b as seq(%'v1),%a as seq(%'v1)) as bool
  samegoal
    replace isPerm(%a as seq(%'v1),%b as seq(%'v1)) as bool
  tags
    asAxiom ""
    derived ""

rule isPerm_refl
  find isPerm(%a as seq(%'v2),%b as seq(%'v2)) as bool
  assume $eq(%a,%b) |-
  samegoal
    replace true as bool
  tags
...
rule isPerm_refl2
  find isPerm(%a as seq(%'v1),%a as seq(%'v1)) as bool
  samegoal
    replace true as bool
  tags
    rewrite "fol simp"
...
rule isPerm_swap
  ...
  samegoal
    replace $and($and(isPerm(%a as seq(%'v2),%b as seq(%'v2)) as bool,seqDom(%a as seq(%'v2),%i as int) as bool) as bool,seqDom(%a as seq(%'v2),%j as int) as bool) as bool
  tags
    rewrite "fol simp"
    derived ""
...
rule permInjective
  find $eq(seqGet(%p as seq(int),%i as int) as int,seqGet(%p as seq(int),%j as int) as int) as bool
  assume isPermN(%p) |-
  assume seqDom(%p,%i) |-
  assume seqDom(%p,%j) |-
  samegoal
    replace $eq(%i as int,%j as int) as bool
  tags
    derived ""
...
problem
  $impl($not($eq(seqGet(seqInv(p as seq(int)) as seq(int),seqGet(p as seq(int),i as int) as int) as int,i as int) as bool) as bool,$or($not(isPermN(p as seq(int)) as bool) as bool,$not(seqDom(p as seq(int),i as int) as bool) as bool) as bool) as bool
