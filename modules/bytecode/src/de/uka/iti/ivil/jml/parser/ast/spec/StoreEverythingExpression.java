...
/**
 * This expression is used to signal that an assignable clause wants to assign
 * to everything.
 * 
 * @author Timm Felden
 */
public final class StoreEverythingExpression extends StoreRefExpression {

    public StoreEverythingExpression() {
