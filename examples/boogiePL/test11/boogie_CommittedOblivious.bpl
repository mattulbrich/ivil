...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /proverMatchDepth:4 CommittedOblivious.dll
...
{
  var stack50000o: ref, stack0o: ref, w0: ref where $Is(w0, W);

  entry:
    assume $IsNotNull(this, CO);
  ...
  block1564:
    // ----- new object  ----- CommittedOblivious.ssc(8,5)
    havoc stack50000o;
    ...
    // ----- call  ----- CommittedOblivious.ssc(8,5)
    assert stack50000o != null;
    call W..ctor(stack50000o);
    // ----- copy  ----- CommittedOblivious.ssc(8,5)
    stack0o := stack50000o;
    // ----- copy  ----- CommittedOblivious.ssc(8,5)
    w0 := stack0o;
    // ----- copy  ----- CommittedOblivious.ssc(9,5)
    stack0o := w0;
    assert stack0o != null;
    stack0o := stack0o;
    // ----- store field  ----- CommittedOblivious.ssc(9,5)
    assert this != null;
    assert !($Heap[this, $inv] <: CO) || $Heap[this, $localinv] == System.Object;
    assert $Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[stack0o, $ownerRef] == this && $Heap[stack0o, $ownerFrame] == CO);
    $Heap[this, CO.w] := stack0o;
    call $UpdateOwnersForRep(this, CO, stack0o);
    assume IsHeap($Heap);
    // ----- call  ----- CommittedOblivious.ssc(10,5)
    assert w0 != null;
    call W.MutatingOp(w0);
    // ----- call  ----- CommittedOblivious.ssc(11,5)
    assert w0 != null;
    call W.PureOp(w0);
    // ----- call  ----- CommittedOblivious.ssc(12,5)
    assert w0 != null;
    call W.ConfinedOp(w0);
    // ----- call  ----- CommittedOblivious.ssc(13,5)
    assert w0 != null;
    call W.StateIndependentOp(w0);
    // ----- call  ----- CommittedOblivious.ssc(14,5)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return  ----- CommittedOblivious.ssc(15,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == CO ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := CO;
    assume IsHeap($Heap);
    return;
...
implementation CO.M(this: ref)
{
  ...
  block1938:
    // ----- load field  ----- CommittedOblivious.ssc(18,5)
    assert this != null;
    stack0o := $Heap[this, CO.w];
    // ----- call  ----- CommittedOblivious.ssc(18,5)
    assert stack0o != null;
    call W.PureOp(stack0o);
    // ----- load field  ----- CommittedOblivious.ssc(19,5)
    assert this != null;
    stack0o := $Heap[this, CO.w];
    // ----- call  ----- CommittedOblivious.ssc(19,5)
    assert stack0o != null;
    call W.ConfinedOp(stack0o);
    // ----- load field  ----- CommittedOblivious.ssc(20,5)
    assert this != null;
    stack0o := $Heap[this, CO.w];
    // ----- call  ----- CommittedOblivious.ssc(20,5)
    assert stack0o != null;
    call W.StateIndependentOp(stack0o);
    // ----- return  ----- CommittedOblivious.ssc(21,3)
    return;
...
implementation CO.P(this: ref)
{
  ...
  block2210:
    // ----- load field  ----- CommittedOblivious.ssc(24,5)
    assert this != null;
    stack0o := $Heap[this, CO.w];
    // ----- call  ----- CommittedOblivious.ssc(24,5)
    assert stack0o != null;
    call W.MutatingOp(stack0o);
    // ----- return  ----- CommittedOblivious.ssc(25,3)
    return;
...
{
  var local0: ref where $Is(local0, CO), stack0o: ref, stack1s: struct, stack1o: ref;
  ...
  block2805:
    // ----- copy  ----- CommittedOblivious.ssc(28,13)
    local0 := this;
    // ----- copy  ----- CommittedOblivious.ssc(28,13)
    stack0o := local0;
    // ----- load token  ----- CommittedOblivious.ssc(28,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, CO);
    // ----- statically resolved GetTypeFromHandle call  ----- CommittedOblivious.ssc(28,13)
    stack1o := TypeObject(CO);
    // ----- local unpack  ----- CommittedOblivious.ssc(28,13)
    assert stack0o != null;
    assert false;
    goto block2822;

  block2822:
    // ----- load field  ----- CommittedOblivious.ssc(29,7)
    assert this != null;
    stack0o := $Heap[this, CO.w];
    // ----- call  ----- CommittedOblivious.ssc(29,7)
    assert stack0o != null;
    call W.MutatingOp(stack0o);
    // ----- branch
    goto block2873;
  ...
  block2873:
    // ----- copy  ----- CommittedOblivious.ssc(30,5)
    stack0o := local0;
    // ----- load token  ----- CommittedOblivious.ssc(30,5)
    havoc stack1s;
    assume $IsTokenForType(stack1s, CO);
    // ----- statically resolved GetTypeFromHandle call  ----- CommittedOblivious.ssc(30,5)
    stack1o := TypeObject(CO);
    // ----- local pack  ----- CommittedOblivious.ssc(30,5)
    assert stack0o != null;
    assert false;
    // ----- nop
    // ----- branch
  ...
  block2839:
    // ----- return  ----- CommittedOblivious.ssc(31,3)
    return;
...
implementation W.MutatingOp(this: ref)
{
  ...
  block3281:
    // ----- return  ----- CommittedOblivious.ssc(38,3)
    return;
...
implementation W.PureOp(this: ref)
{
  ...
  block3451:
    // ----- return  ----- CommittedOblivious.ssc(43,3)
    return;
...
implementation W.ConfinedOp(this: ref)
{
  ...
  block3621:
    // ----- return  ----- CommittedOblivious.ssc(48,3)
    return;
...
implementation W.StateIndependentOp(this: ref)
{
  ...
  block3791:
    // ----- return  ----- CommittedOblivious.ssc(53,3)
    return;
...
implementation W..ctor(this: ref)
{
  ...
  block3961:
    // ----- call  ----- CommittedOblivious.ssc(34,14)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
