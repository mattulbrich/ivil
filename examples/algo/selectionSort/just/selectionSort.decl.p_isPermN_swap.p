...
problem
  $impl($and($and(isPermN(a as seq(int)) as bool,seqDom(a as seq(int),i as int) as bool) as bool,seqDom(a as seq(int),j as int) as bool) as bool,isPermN(seqSwap(a as seq(int),i as int,j as int) as seq(int)) as bool) as bool
