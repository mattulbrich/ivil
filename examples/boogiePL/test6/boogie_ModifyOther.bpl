...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo ModifyOther
...
implementation A..ctor(this: ref)
{
  ...
  block2550:
    // ----- load constant 0  ----- ModifyOther.ssc(5,18)
    stack0i := 0;
    // ----- store field  ----- ModifyOther.ssc(5,3)
    assert this != null;
...
{
  var stack0o: ref, i: int where InRange(i, System.Int32), stack0i: int, stack0b: bool, local3791: ref where $Is(local3791, A), stack1s: struct, stack1o: ref, temp0: exposeVersionType, local3825: int where InRange(local3825, System.Int32), $Heap$block3485$LoopPreheader: [ref,<x>name]x;
  ...
  block3468:
    // ----- load constant 0  ----- ModifyOther.ssc(15,10)
    i := 0;
    goto block3485$LoopPreheader;

  block3485:
    // ----- default loop invariant: allocation and ownership are stable  ----- ModifyOther.ssc(15,25)
    assume (forall $o: ref :: $Heap$block3485$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block3485$LoopPreheader[$ot, $allocated] == true && $Heap$block3485$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block3485$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block3485$LoopPreheader[$ot, $ownerFrame]) && $Heap$block3485$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- ModifyOther.ssc(15,25)
    assume (forall $o: ref :: ($Heap$block3485$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block3485$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block3485$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block3485$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- ModifyOther.ssc(15,25)
    assert (forall $o: ref :: $o != null && $Heap$block3485$LoopPreheader[$o, $allocated] == true ==> $Heap$block3485$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block3485$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 10  ----- ModifyOther.ssc(15,25)
    stack0i := 10;
    // ----- binary operator  ----- ModifyOther.ssc(15,21)
    // ----- branch  ----- ModifyOther.ssc(15,21)
    goto true3485to3638, false3485to3502;
  ...
  block3502:
    // ----- load field  ----- ModifyOther.ssc(17,15)
    assert this != null;
    local3791 := $Heap[this, Test.a];
    // ----- copy  ----- ModifyOther.ssc(17,15)
    stack0o := local3791;
    // ----- load token  ----- ModifyOther.ssc(17,15)
    havoc stack1s;
    assume $IsTokenForType(stack1s, A);
    // ----- statically resolved GetTypeFromHandle call  ----- ModifyOther.ssc(17,15)
    stack1o := TypeObject(A);
    // ----- local unpack  ----- ModifyOther.ssc(17,15)
    assert stack0o != null;
  ...
  block3519:
    // ----- load field  ----- ModifyOther.ssc(17,20)
    assert this != null;
    stack0o := $Heap[this, Test.a];
    // ----- store field  ----- ModifyOther.ssc(17,20)
    assert stack0o != null;
    assert !($Heap[stack0o, $inv] <: A) || $Heap[stack0o, $localinv] == System.Object;
    $Heap[stack0o, A.X] := i;
    assume IsHeap($Heap);
    // ----- branch
    goto block3689;
  ...
  block3672:
    // ----- return  ----- ModifyOther.ssc(19,3)
    return;

  block3689:
    // ----- copy  ----- ModifyOther.ssc(17,29)
    stack0o := local3791;
    // ----- load token  ----- ModifyOther.ssc(17,29)
    havoc stack1s;
    assume $IsTokenForType(stack1s, A);
    // ----- statically resolved GetTypeFromHandle call  ----- ModifyOther.ssc(17,29)
    stack1o := TypeObject(A);
    // ----- local pack  ----- ModifyOther.ssc(17,29)
    assert stack0o != null;
  ...
  block3587:
    // ----- copy  ----- ModifyOther.ssc(15,29)
    local3825 := i;
    // ----- load constant 1  ----- ModifyOther.ssc(15,29)
    stack0i := 1;
    // ----- binary operator  ----- ModifyOther.ssc(15,29)
    stack0i := local3825 + stack0i;
    // ----- copy  ----- ModifyOther.ssc(15,29)
    i := stack0i;
    // ----- copy  ----- ModifyOther.ssc(15,29)
    stack0i := local3825;
  ...
  block3485$LoopPreheader:
    $Heap$block3485$LoopPreheader := $Heap;
    goto block3485;
...
implementation Test..ctor(this: ref)
{
  ...
  block3944:
    // ----- new object  ----- ModifyOther.ssc(10,26)
    havoc stack50000o;
    ...
    // ----- call  ----- ModifyOther.ssc(10,26)
    assert stack50000o != null;
    call A..ctor(stack50000o);
    // ----- copy  ----- ModifyOther.ssc(10,3)
    stack0o := stack50000o;
    // ----- store field  ----- ModifyOther.ssc(10,3)
    assert this != null;
    assert !($Heap[this, $inv] <: Test) || $Heap[this, $localinv] == System.Object;
    assert $Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[stack0o, $ownerRef] == this && $Heap[stack0o, $ownerFrame] == Test);
    $Heap[this, Test.a] := stack0o;
    call $UpdateOwnersForRep(this, Test, stack0o);
    assume IsHeap($Heap);
    goto block3961;

  block3961:
    // ----- call  ----- ModifyOther.ssc(8,14)
    assert this != null;
    call System.Object..ctor(this);
    goto block3978;
