 ...
 */
@ SuppressWarnings("all") public final class ASTParser implements ASTParserConstants {
  ...
  Token mod;
    ...
    while (true) {
      ...
      case STRICTFP:
        ...
        break;
      case BEGIN_SPEC:
        jj_consume_token(BEGIN_SPEC);
        mod = jj_consume_token(JML_MODIFIER);
        jj_consume_token(END_SPEC);
        if (mod.image.equals("pure")) {
            modifiers = addModifier(modifiers, ModifierSet.PURE, token);
          } else if (mod.image.equals("helper")) {
            modifiers = addModifier(modifiers, ModifierSet.HELPER, token);
          } else if (mod.image.equals("nullable")) {
            modifiers = addModifier(modifiers, ModifierSet.NULLABLE, token);
          } else if (mod.image.equals("non_null")) {
            modifiers = addModifier(modifiers, ModifierSet.NON_NULL, token);
          }
        if (beginLine == - 1)
        {
          beginLine = token.beginLine;
 ...
 */
      ...
      case LT:
        ...
        default:
          ...
          if (jj_2_5(2147483647)) {
            ret = ConstructorDeclaration(modifier, methodSpec);
            ...
            case IDENTIFIER:
            case LT:
              ret = MethodDeclaration(modifier, methodSpec);
              break;
            case BEGIN_SPEC:
            case BEGIN_SINGLE_SPEC:
              ret = InvariantDeclaration(modifier);
              break;
            default:
              jj_la1[28] = jj_gen;
              jj_consume_token(-1);
  ...
  final public MethodDeclaration MethodDeclaration(Modifier modifier, MethodSpecification methodSpec) throws ParseException {
  ...
  int column = modifier.beginColumn;
    ...
    {if (true) {
        return new MethodDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), methodSpec, modifier.modifiers, modifier.annotations, typeParameters, type, name, parameters, arrayCount, throws_, block);
    }}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ConstructorDeclaration ConstructorDeclaration(Modifier modifier, MethodSpecification methodSpec) throws ParseException {
  List typeParameters = null;
  String name;
  List parameters;
  List throws_ = null;
  ...
  int beColumn = 0;
    ...
    {if (true) {
        return new ConstructorDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(), methodSpec, modifier.modifiers, modifier.annotations, typeParameters, name, parameters, throws_, new BlockStmt(bbLine, bbColumn, token.endLine, token.endColumn, stmts));
    }}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  ...
  NameExpr ret;
    ...
    case IDENTIFIER:
      ...
      break;
    case JML_IDENTIFIER:
      jj_consume_token(JML_IDENTIFIER);
      break;
    default:
      jj_la1[58] = jj_gen;
      jj_consume_token(-1);
 ...
 */
  ...
  final public Expression EquivalenceExpression() throws ParseException {
  Expression ret;
  Expression right;
    ret = ImpliesExpression();
    label_25:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case EQUIVALENCE:
      ...
      ret = new BinaryExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret, right, BinaryExpr.Operator.equivalent);
        break;
      case INEQUIVALENCE:
        jj_consume_token(INEQUIVALENCE);
        right = ImpliesExpression();
      ret = new BinaryExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret, right, BinaryExpr.Operator.notEquivalent);
        break;
      default:
        jj_la1[64] = jj_gen;
        jj_consume_token(-1);
  ...
  Expression right;
    ...
    while (true) {
      ...
      ret = new BinaryExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret, right, BinaryExpr.Operator.implies);
    }
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case EXPLIES:
      jj_consume_token(EXPLIES);
      right = ImpliesExpression();
      ret = new BinaryExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret, right, BinaryExpr.Operator.explies);
      break;
    default:
      jj_la1[66] = jj_gen;
      ;
  ...
  Expression inner;
    if (jj_2_27(2)) {
      ret = QuantificationExpression();
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case TYPE:
      case TYPEOF:
      case ELEMENTTYPE:
        ret = TypeRelationExpression();
        break;
      case BOOLEAN:
      case BYTE:
      case CHAR:
  ...
  final public Expression QuantificationExpression() throws ParseException {
  Expression first, second = null;
  Token quantifier, begin, end;
  Parameter param;
  List < Parameter > targets = new ArrayList < Parameter > (4);
    ...
    {if (true) {
        return new QuantificationExpression(begin, end, quantifier.image, targets, first, second);
    }}
    throw new Error("Missing return statement in function");
  }

  final public Expression TypeRelationExpression() throws ParseException {
  ...
  boolean isEquality = true;
    ...
    {if (true) {
        return new TypeRelationExpression(left, right, isEquality);
    }}
    throw new Error("Missing return statement in function");
  }

  final public TypeExpression TypeExpression() throws ParseException {
  Expression expr;
  Type type;
  Token keyword;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TYPEOF:
      keyword = jj_consume_token(TYPEOF);
      jj_consume_token(LPAREN);
      expr = Expression();
      jj_consume_token(RPAREN);
      {if (true) {
        return new TypeExpression(keyword.image, expr);
    }}
      break;
    case ELEMENTTYPE:
      keyword = jj_consume_token(ELEMENTTYPE);
      jj_consume_token(LPAREN);
      expr = Expression();
      jj_consume_token(RPAREN);
      {if (true) {
...
*       SPECIFICATIONS        *
\*****************************/
  final public MethodSpecification MethodSpecification() throws ParseException {
  Token begin, end;
  List < MethodContract > contracts = new LinkedList < MethodContract > ();
  MethodContract t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BEGIN_SPEC:
      begin = jj_consume_token(BEGIN_SPEC);
      break;
    case BEGIN_SINGLE_SPEC:
      begin = jj_consume_token(BEGIN_SINGLE_SPEC);
      break;
    default:
      jj_la1[148] = jj_gen;
      jj_consume_token(-1);
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case END_SPEC:
      end = jj_consume_token(END_SPEC);
      break;
    case END_SINGLE_SPEC:
      end = jj_consume_token(END_SINGLE_SPEC);
      break;
    default:
      jj_la1[150] = jj_gen;
      jj_consume_token(-1);
    ...
    {if (true) {
        return new MethodSpecification(begin, end, contracts);
    }}
    throw new Error("Missing return statement in function");
  }

  final public MethodContract MethodContract() throws ParseException {
  List < MethodContract.Line > lines = new LinkedList < MethodContract.Line > ();
  MethodContract.LineType type;
  Expression expr;
  ReferenceType refType;
  List < StoreRefExpression > storeRef;
    label_52:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case DIVERGES:
      ...
      case REQUIRES:
        ...
        type = MethodContract.LineType.requires;
          break;
        case ENSURES:
          jj_consume_token(ENSURES);
        type = MethodContract.LineType.ensures;
          break;
        case MEASURED_BY:
          jj_consume_token(MEASURED_BY);
        type = MethodContract.LineType.measured_by;
          break;
        case DIVERGES:
          jj_consume_token(DIVERGES);
        type = MethodContract.LineType.diverges;
          break;
        default:
          jj_la1[151] = jj_gen;
          jj_consume_token(-1);
        ...
        expr = Expression();
        jj_consume_token(SEMICOLON);
      lines.add(new MethodContract.Line(type, expr));
        break;
      case SIGNALS:
        jj_consume_token(SIGNALS);
      type = MethodContract.LineType.signals;
        jj_consume_token(LPAREN);
        refType = ReferenceType();
        jj_consume_token(RPAREN);
        expr = Expression();
        jj_consume_token(SEMICOLON);
      lines.add(new MethodContract.Line(type, refType, expr));
        break;
      case ASSIGNABLE:
        jj_consume_token(ASSIGNABLE);
      type = MethodContract.LineType.assignable;
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case NOTHING:
          jj_consume_token(NOTHING);
        storeRef = new ArrayList < StoreRefExpression > (0);
          break;
        case EVERYTHING:
          jj_consume_token(EVERYTHING);
        storeRef = new ArrayList < StoreRefExpression > (1);
        storeRef.add(new StoreEverythingExpression());
          break;
        case SUPER:
        case THIS:
        case JML_IDENTIFIER:
        case IDENTIFIER:
          storeRef = StoreRefList();
          break;
        default:
          jj_la1[152] = jj_gen;
          jj_consume_token(-1);
        ...
        jj_consume_token(SEMICOLON);
      lines.add(new MethodContract.Line(type, storeRef));
        break;
      default:
        jj_la1[153] = jj_gen;
        jj_consume_token(-1);
    ...
    {if (true) {
        return new MethodContract(lines);
    }}
    throw new Error("Missing return statement in function");
  }

  final public List < StoreRefExpression > StoreRefList() throws ParseException {
  LinkedList < StoreRefExpression > result = new LinkedList < StoreRefExpression > ();
  StoreRefExpression t;
...
// store ref expression, without nothing and everything keywords
  final public StoreRefExpression StoreRefExpression() throws ParseException {
  Expression ref, field = null, tmp;
  boolean isArray = false;
    ...
    case THIS:
      jj_consume_token(THIS);
      ref = new ThisExpr(token.beginLine, token.beginColumn, token.endLine, token.endColumn, null);
      break;
    case SUPER:
      jj_consume_token(SUPER);
      ref = new SuperExpr(token.beginLine, token.beginColumn, token.endLine, token.endColumn, null);
      break;
    default:
      jj_la1[156] = jj_gen;
      jj_consume_token(-1);
    ...
    while (true) {
      ...
      case IDENTIFIER:
        ...
        {
          ref = new FieldAccessExpr(ref, ((NameExpr) field).getName());
          field = tmp;
        }
        break;
      case THIS:
    ...
    case DOT:
      ...
      case DOT:
        jj_consume_token(DOT);
        jj_consume_token(STAR);
      field = new AnyFieldExpression(token.beginLine, token.beginColumn, token.endLine, token.endColumn);
        break;
      case LBRACKET:
        jj_consume_token(LBRACKET);
      isArray = true;
        ...
        case MINUS:
          ...
          case 167:
            ...
            tmp = Expression();
          field = new ArrayRangeExpression(field, tmp);
            break;
          default:
            jj_la1[158] = jj_gen;
            ;
    ...
    if (null == field) {if (true) {
        return new StoreRefExpression(null, ref, isArray);
    }}
    else {if (true) {
        return new StoreRefExpression(ref, field, isArray);
    }}
    throw new Error("Missing return statement in function");
  }

  final public InvariantDeclaration InvariantDeclaration(Modifier mod) throws ParseException {
  Expression expr;
  Token begin, end;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BEGIN_SPEC:
    ...
    {if (true) {
        return new InvariantDeclaration(begin, end, expr, mod.modifiers);
    }}
    throw new Error("Missing return statement in function");
  }

  final public JMLStatement JMLStatement() throws ParseException {
  Expression expr, variant = null;
  List < StoreRefExpression > storeRef = null;
  Token keyword;
  Token begin, end;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BEGIN_SPEC:
    ...
    case ASSUME:
      ...
      break;
    case LOOP_INVARIANT:
      keyword = jj_consume_token(LOOP_INVARIANT);
      expr = Expression();
      jj_consume_token(SEMICOLON);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case DECREASING:
    ...
    {if (true) {
        return new JMLStatement(begin, end, keyword.image, expr, variant, storeRef);
    }}
    throw new Error("Missing return statement in function");
  }
  ...
  private boolean jj_3R_285() {
    if (jj_scan_token(INEQUIVALENCE)) {
        return true;
    }
    if (jj_3R_206()) {
        return true;
  ...
  private boolean jj_3R_427() {
    if (jj_scan_token(LOOP_INVARIANT)) {
        return true;
    }
    if (jj_3R_82()) {
        return true;
  ...
  private boolean jj_3R_67() {
    if (jj_scan_token(BEGIN_SPEC)) {
        return true;
    }
    if (jj_scan_token(JML_MODIFIER)) {
        return true;
    }
    if (jj_scan_token(END_SPEC)) {
        return true;
    }
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x2020040,0x1,0x0,0x0,0x0,0x20040,0x2000000,0x2020040,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x432a00c0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x432a00c0,0x2000000,0x412800c0,0x432a00c0,0x0,0x0,0x0,0x41280000,0x41280000,0x0,0x0,0x0,0x0,0x0,0x0,0x412a0040,0x0,0x0,0x0,0x0,0x0,0x41280000,0x6b3e00c0,0x0,0x41280000,0x41280000,0x0,0x41280000,0x0,0x0,0x41280000,0x41280000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x41280000,0x0,0x0,0x41280000,0x0,0x41280000,0x41280000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x41280000,0x0,0x0,0x41280000,0x0,0x0,0x0,0x693c00c0,0x0,0x693c00c0,0x0,0x0,0x0,0x41280000,0x10400000,0x10400000,0x80000000,0x412a0040,0x41280000,0x41280000,0x412a0040,0x41280000,0x0,0x0,0x0,0x41280000,0x800000,0x0,0x800000,0x0,0x0,0x0,0x41280000,0x41280000,0x0,0x432a0040,0x43280000,0x432a0040,0x10000000,0xc0,0x0,0x600,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x41280000,0x0,0x0,0xc0,0x600,0xc0,0x40000,0x0,0x0,0x0,0x40000,0x600,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x400,0x1338a009,0x0,0x0,0x1000000,0x0,0x13388008,0x2001,0x1338a009,0x2000,0x0,0x2,0x200,0x0,0x0,0x200,0x0,0x0,0x13b8f029,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x13b8f029,0x2001,0x805020,0x13b8f029,0x0,0x0,0x0,0x24835024,0x24835024,0x0,0x0,0x0,0x80000000,0x0,0x0,0x13b8d028,0x0,0x0,0x80000000,0x0,0x0,0x24835024,0x7ffbf16c,0x1000000,0x805020,0x805020,0x0,0x805020,0x4000002,0x4000002,0x805020,0x805020,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x24835024,0x0,0x0,0x24835024,0x0,0x805020,0x24835024,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x24030004,0x0,0x0,0x0,0x0,0x0,0x20010000,0x0,0x20004,0x4,0x24835024,0x0,0x0,0x805020,0x0,0x0,0x0,0x7cc35164,0x0,0x7cc35164,0x0,0x0,0x0,0x24835024,0x0,0x0,0x0,0x37bbd02c,0x24835024,0x24835024,0x37bbd02c,0x24835024,0x0,0x0,0x0,0x24835024,0x0,0x10,0x10,0x0,0x0,0x0,0x24835024,0x24835024,0x0,0x13b8f029,0x807021,0x13b8f029,0x0,0x0,0x0,0x0,0x0,0x24000000,0x0,0x0,0x0,0x24000000,0x20000000,0x0,0x24835024,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x24000000,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0