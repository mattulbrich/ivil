...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3859:
    // ----- load constant 0  ----- Chunker.ssc(5,13)
    stack0i := 0;
    // ----- load field  ----- Chunker.ssc(5,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker.ssc(5,13)
    // ----- branch
  ...
  block4012:
    // ----- load constant 0  ----- Chunker.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker.ssc(7,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker.ssc(7,13)
    // ----- branch
  ...
  block4029:
    // ----- load field  ----- Chunker.ssc(7,23)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker.ssc(7,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker.ssc(7,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker.ssc(7,23)
    // ----- branch
  ...
  block4097:
    assume false;
    // ----- new object  ----- Chunker.ssc(7,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker.ssc(7,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker.ssc(7,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker.ssc(7,3)
    assert stack0o != null;
    assume false;
    return;
...
implementation Chunker.NextChunk(this: ref) returns ($result: ref)
{
  ...
  block5661:
    // ----- FrameGuard processing  ----- Chunker.ssc(12,13)
    temp0 := this;
    // ----- load token  ----- Chunker.ssc(12,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Chunker);
    // ----- statically resolved GetTypeFromHandle call  ----- Chunker.ssc(12,13)
    stack1o := TypeObject(Chunker);
    // ----- local unpack  ----- Chunker.ssc(12,13)
    assert temp0 != null;
  ...
  block5695:
    // ----- load field  ----- Chunker.ssc(14,11)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker.ssc(14,15)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker.ssc(14,11)
    stack0i := stack0i + stack1i;
    // ----- load field  ----- Chunker.ssc(14,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker.ssc(14,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker.ssc(14,11)
    // ----- branch  ----- Chunker.ssc(14,7)
  ...
  block5746:
    // ----- load field  ----- Chunker.ssc(17,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker.ssc(17,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- call  ----- Chunker.ssc(17,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32(stack0o, stack1i);
    // ----- nop  ----- Chunker.ssc(19,7)
    goto block5763;

  block5712:
    // ----- load field  ----- Chunker.ssc(15,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker.ssc(15,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker.ssc(15,30)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker.ssc(15,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i);
    goto block5729;

  block5729:
    // ----- branch  ----- Chunker.ssc(16,9)
    goto block5763;
  ...
  block5780:
    // ----- load field  ----- Chunker.ssc(19,7)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- string length  ----- Chunker.ssc(19,12)
    assert s != null;
    stack1i := $StringLength(s);
    // ----- binary operator  ----- Chunker.ssc(19,7)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker.ssc(19,7)
    assert this != null;
  ...
  block6307:
    // ----- load token  ----- Chunker.ssc(21,5)
    havoc stack0s;
    assume $IsTokenForType(stack0s, Chunker);
    // ----- statically resolved GetTypeFromHandle call  ----- Chunker.ssc(21,5)
    stack0o := TypeObject(Chunker);
    // ----- local pack  ----- Chunker.ssc(21,5)
    assert temp0 != null;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block7837:
    // ----- store field  ----- Chunker.ssc(27,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker.ssc(28,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker.ssc(29,9)
    stack0i := 0;
    // ----- store field  ----- Chunker.ssc(29,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block8024:
    // ----- FrameGuard processing  ----- Chunker.ssc(31,3)
    temp0 := this;
    // ----- classic pack  ----- Chunker.ssc(31,3)
    assert temp0 != null;
