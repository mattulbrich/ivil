 ...
 * for the three rules:
 * <ol>
 * <li>replace_known_right
 * <li>replace_known_left
 * <li>equality_apply
 * </ol>
 *
 * Since these rules match against every subterm and have a generic assumption,
 * searching application possibilities for them using the usual matching
 * strategies would result in a slowdown of factor 10.
 *
 * <h4>Ideas</h4>
 * <ul>
 * <li>Apply the rule application with the least depth for the find term hereby
 * ensuring a certain degree of fairness.
 * </ul>
 */
public class KnowledgeStrategy extends AbstractStrategy {
    ...
    private class Detector {
         ...
         */
        private final ProofNode target;

        /**
         * A map from all terms in the antecedent to their term selector.
         */
        private final Map<Term,TermSelector> antecedentMap;

        /**
         * A map from all terms in the succedent to their term selector.
         */
        private final Map<Term,TermSelector> succedentMap;

        /**
         * A map from all left-hand-sides of equalitites terms in the antecedent
         * to their right-hand-sides.
         */
        private final Map<Term,TermSelector> antecedentEqualities;

        /**
         * The antecedent.
         */
        private final List<Term> antecedent;

        /**
         * The succedent.
         */
        private final List<Term> succedent;
