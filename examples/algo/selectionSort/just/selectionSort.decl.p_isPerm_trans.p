...
problem
  $impl($or($not(isPerm(a as seq('v1),c as seq('v1)) as bool) as bool,$not(isPerm(b as seq('v1),c as seq('v1)) as bool) as bool) as bool,$or($not(isPerm(a as seq('v1),b as seq('v1)) as bool) as bool,$not(isPerm(b as seq('v1),c as seq('v1)) as bool) as bool) as bool) as bool
