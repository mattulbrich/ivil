...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo DefinedExpressions
...
{
  var den: int where InRange(den, System.Int32), stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);

  entry:
    assume $IsNotNull(this, DefinedExpressions);
  ...
  block3587:
    // ----- load constant 5  ----- DefinedExpressions.ssc(4,12)
    stack0i := 5;
    // ----- binary operator  ----- DefinedExpressions.ssc(4,12)
    assert den != 0;
    stack0i := stack0i / den;
    // ----- copy  ----- DefinedExpressions.ssc(4,5)
  ...
  block3621:
    ...
    // ----- copy  ----- DefinedExpressions.ssc(5,3)
    stack0i := return.value;
    // ----- return  ----- DefinedExpressions.ssc(5,3)
    $result := stack0i;
    return;
...
{
  var b: bool where true, a: ref where $IsNotNull(a, ValueArray(System.Int32, 1)), stack0b: bool, stack0i: int, stack1o: ref, stack1i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block4437:
    // ----- copy  ----- DefinedExpressions.ssc(7,9)
    stack0b := b;
    // ----- unary operator  ----- DefinedExpressions.ssc(7,9)
    // ----- branch  ----- DefinedExpressions.ssc(7,5)
    goto true4437to4488, false4437to4454;
  ...
  block4488:
    // ----- load constant 2  ----- DefinedExpressions.ssc(10,14)
    stack0i := 2;
    // ----- array length  ----- DefinedExpressions.ssc(10,22)
    assert a != null;
    stack1i := $Length(a);
    // ----- binary operator  ----- DefinedExpressions.ssc(10,14)
    stack0i := stack0i + stack1i;
    // ----- copy  ----- DefinedExpressions.ssc(10,7)
    return.value := stack0i;
    // ----- branch
    goto block4539;

  block4454:
    // ----- load constant 5  ----- DefinedExpressions.ssc(8,14)
    stack0i := 5;
    // ----- load constant "hello"  ----- DefinedExpressions.ssc(8,18)
    stack1o := $stringLiteral0;
    // ----- string length  ----- DefinedExpressions.ssc(8,18)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- DefinedExpressions.ssc(8,14)
    assert stack1i != 0;
    stack0i := stack0i / stack1i;
    // ----- copy  ----- DefinedExpressions.ssc(8,7)
    return.value := stack0i;
    // ----- branch
    goto block4539;
...
implementation DefinedExpressions.Modulo$System.Int32(this: ref, den$in: int) returns ($result: int)
{
  ...
  block4896:
    // ----- load constant 5  ----- DefinedExpressions.ssc(15,12)
    stack0i := 5;
    // ----- binary operator  ----- DefinedExpressions.ssc(15,12)
    assert den != 0;
    stack0i := stack0i % den;
    // ----- copy  ----- DefinedExpressions.ssc(15,5)
    return.value := stack0i;
    // ----- branch
    goto block4913;
  ...
  block4930:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- DefinedExpressions.ssc(16,3)
    stack0i := return.value;
    // ----- return  ----- DefinedExpressions.ssc(16,3)
    $result := stack0i;
    return;
...
implementation DefinedExpressions.Modulo$System.Boolean$System.Int32.array$notnull(this: ref, b$in: bool, a$in: ref) returns ($result: int)
{
  ...
  block5695:
    // ----- copy  ----- DefinedExpressions.ssc(18,9)
    stack0b := b;
    // ----- unary operator  ----- DefinedExpressions.ssc(18,9)
    // ----- branch  ----- DefinedExpressions.ssc(18,5)
  ...
  block5746:
    // ----- load constant 1  ----- DefinedExpressions.ssc(21,14)
    stack0i := 1;
    // ----- array length  ----- DefinedExpressions.ssc(21,22)
    assert a != null;
    stack1i := $Length(a);
    // ----- binary operator  ----- DefinedExpressions.ssc(21,14)
    stack0i := stack0i + stack1i;
    // ----- copy  ----- DefinedExpressions.ssc(21,7)
    return.value := stack0i;
    // ----- branch
    goto block5797;

  block5712:
    // ----- load constant 5  ----- DefinedExpressions.ssc(19,14)
    stack0i := 5;
    // ----- load constant "hello"  ----- DefinedExpressions.ssc(19,18)
    stack1o := $stringLiteral0;
    // ----- string length  ----- DefinedExpressions.ssc(19,18)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- DefinedExpressions.ssc(19,14)
    assert stack1i != 0;
    stack0i := stack0i % stack1i;
    // ----- copy  ----- DefinedExpressions.ssc(19,7)
    return.value := stack0i;
    // ----- branch
    goto block5797;
...
implementation DefinedExpressions..ctor(this: ref)
{
  ...
  block6103:
    // ----- call  ----- DefinedExpressions.ssc(1,14)
    assert this != null;
  ...
  block6137:
    ...
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == DefinedExpressions ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := DefinedExpressions;
    assume IsHeap($Heap);
    return;
