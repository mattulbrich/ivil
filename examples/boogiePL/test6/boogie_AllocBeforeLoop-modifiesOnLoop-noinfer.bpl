...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /modifiesOnLoop /noinfer AllocBeforeLoop.dll
...
{
  var stack0i: int, arr: ref where $Is(arr, ValueArray(System.Int32, 1)), i: int where InRange(i, System.Int32), stack0b: bool, stack0o: ref, stack1i: int, local2: int where InRange(local2, System.Int32), $Heap$block1224$LoopPreheader: [ref,<x>name]x;
  ...
  block1207:
    // ----- load constant 10  ----- AllocBeforeLoop.ssc(5,5)
    stack0i := 10;
    // ----- new array  ----- AllocBeforeLoop.ssc(5,5)
    assert 0 <= stack0i;
    havoc arr;
    ...
    assume IsHeap($Heap);
    // ----- load constant 0  ----- AllocBeforeLoop.ssc(6,10)
    i := 0;
    goto block1224$LoopPreheader;

  block1224:
    // ----- default loop invariant: allocation and ownership are stable  ----- AllocBeforeLoop.ssc(6,21)
    assume (forall $o: ref :: $Heap$block1224$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block1224$LoopPreheader[$ot, $allocated] == true && $Heap$block1224$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block1224$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block1224$LoopPreheader[$ot, $ownerFrame]) && $Heap$block1224$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- AllocBeforeLoop.ssc(6,21)
    assume (forall $o: ref :: ($Heap$block1224$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block1224$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block1224$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block1224$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- AllocBeforeLoop.ssc(6,21)
    assert (forall $o: ref :: $o != null && $Heap$block1224$LoopPreheader[$o, $allocated] == true ==> $Heap$block1224$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block1224$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- default loop invariant: modifies  ----- AllocBeforeLoop.ssc(6,21)
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old(true) && old($o != this || $f != $exposeVersion) ==> $Heap$block1224$LoopPreheader[$o, $f] == $Heap[$o, $f]);
    // ----- load constant 10  ----- AllocBeforeLoop.ssc(6,21)
    stack0i := 10;
    // ----- binary operator  ----- AllocBeforeLoop.ssc(6,21)
    // ----- branch  ----- AllocBeforeLoop.ssc(6,21)
    goto true1224to1258, false1224to1241;
  ...
  block1258:
    // ----- return  ----- AllocBeforeLoop.ssc(11,3)
    return;

  block1241:
    // ----- copy  ----- AllocBeforeLoop.ssc(9,7)
    stack0o := arr;
    // ----- copy  ----- AllocBeforeLoop.ssc(9,7)
    stack1i := i;
    // ----- store element  ----- AllocBeforeLoop.ssc(9,7)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
    $Heap[stack0o, $elements] := ValueArraySet($Heap[stack0o, $elements], stack1i, i);
    assume IsHeap($Heap);
    // ----- copy  ----- AllocBeforeLoop.ssc(6,29)
    local2 := i;
    // ----- load constant 1  ----- AllocBeforeLoop.ssc(6,29)
    stack0i := 1;
    // ----- binary operator  ----- AllocBeforeLoop.ssc(6,29)
  ...
  block1224$LoopPreheader:
    $Heap$block1224$LoopPreheader := $Heap;
    goto block1224;
