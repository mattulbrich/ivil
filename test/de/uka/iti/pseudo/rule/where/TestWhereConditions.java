...
public class TestWhereConditions extends TestCaseWithEnv {
    ...
    public void testProgramFree() throws Exception {
        ...
        assertFalse(pf.check(null, new Term[] { makeTerm("1+2 = [skip]3") }, null, null, env));
    ...
    public void testCanEval() throws Exception {
        ...
        assertFalse(can.check(null, new Term[] { makeTerm("$$skolem(1)") }, new RuleApplicationMaker(), null, env));
