...
problem
  $impl($and($and(isPerm(a as seq('v2),b as seq('v2)) as bool,seqDom(a as seq('v2),i as int) as bool) as bool,seqDom(a as seq('v2),j as int) as bool) as bool,isPerm(b as seq('v2),seqSwap(a as seq('v2),i as int,j as int) as seq('v2)) as bool) as bool
