...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker6
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3621:
    // ----- load constant 0  ----- Chunker6.ssc(5,13)
    stack0i := 0;
    // ----- load field  ----- Chunker6.ssc(5,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker6.ssc(5,13)
    // ----- branch
    goto true3621to3740, false3621to3638;
  ...
  block3774:
    // ----- load constant 0  ----- Chunker6.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker6.ssc(7,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker6.ssc(7,13)
    // ----- branch
    goto true3774to3893, false3774to3791;
  ...
  block3791:
    ...
    // ----- unary operator
    // ----- branch
    goto true3791to3842, false3791to3808;
  ...
  block3808:
    assume false;
    // ----- new object  ----- Chunker6.ssc(7,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker6.ssc(7,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker6.ssc(7,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker6.ssc(7,3)
    assert stack0o != null;
    assume false;
    return;
...
implementation Chunker.NextChunk(this: ref) returns ($result: ref)
{
  ...
  block4964:
    // ----- load field  ----- Chunker6.ssc(12,16)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker6.ssc(12,30)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker6.ssc(12,33)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker6.ssc(12,5)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i);
    goto block4981;

  block4981:
    // ----- load field  ----- Chunker6.ssc(13,5)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker6.ssc(13,10)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker6.ssc(13,5)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker6.ssc(13,5)
    assert this != null;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block6256:
    // ----- store field  ----- Chunker6.ssc(19,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker6.ssc(20,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker6.ssc(21,9)
    stack0i := 0;
    // ----- store field  ----- Chunker6.ssc(21,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block6443:
    // ----- FrameGuard processing  ----- Chunker6.ssc(23,3)
    temp1 := this;
    // ----- classic pack  ----- Chunker6.ssc(23,3)
    assert temp1 != null;
