...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo IntToString
...
{
  var local2550: int where InRange(local2550, System.Int32), stack0o: ref;
  ...
  block2431:
    // ----- load constant 5  ----- IntToString.ssc(5,34)
    local2550 := 5;
    // ----- load address  ----- IntToString.ssc(5,34)
    havoc stack0o;
    goto block2448;

  block2448:
    // ----- call  ----- IntToString.ssc(5,34)
    call local2550, stack0o := System.Int32.ToString(local2550);
    // ----- call  ----- IntToString.ssc(5,9)
