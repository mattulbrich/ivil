...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker2
...
implementation Chunker.NextChunk(this: ref) returns ($result: ref)
{
  ...
  block2584:
    ...
    // ----- copy  ----- Chunker2.ssc(12,3)
    stack0o := return.value;
    // ----- return  ----- Chunker2.ssc(12,3)
    $result := stack0o;
    return;
...
{
  var source: ref where $IsNotNull(source, System.String), chunkSize: int where InRange(chunkSize, System.Int32), temp0: exposeVersionType, temp1: exposeVersionType, stack0i: int, temp2: exposeVersionType;
  ...
  block3451:
    // ----- call  ----- Chunker2.ssc(15,3)
    assert this != null;
    call System.Object..ctor(this);
    goto block3468;

  block3468:
    // ----- store field  ----- Chunker2.ssc(16,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker2.ssc(17,5)
    assert this != null;
    havoc temp1;
    $Heap[this, $exposeVersion] := temp1;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker2.ssc(18,9)
    stack0i := 0;
    // ----- store field  ----- Chunker2.ssc(18,5)
    assert this != null;
    havoc temp2;
