 ...
 */
public final class SubtermReplacer extends RebuildingTermVisitor {
     ...
     */
    private final int replaceNumber;
     ...
     *             fails otherwise.
     */
    public static @NonNull Term replace(Term term, int subtermNo,
            Term replaceWith) throws TermException {
     ...
     *             fails otherwise.
     */
    public static @NonNull Term replace(Term term, SubtermSelector sel, Term replaceWith)
            throws TermException {
        return replace(term, sel.getLinearIndex(term), replaceWith);
    }

    /* (non-Javadoc)
     * @see de.uka.iti.pseudo.term.creation.
     *         RebuildingTermVisitor#defaultVisitTerm(de.uka.iti.pseudo.term.Term)
     */
    @Override
