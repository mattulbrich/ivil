  ...
  private void initGUI() {
    {
      ...
      {
        jIcon = new JLabel();
        getContentPane().add(jIcon, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(20, 20, 10, 10), 0, 0));
        jIcon.setIcon(errorIcon);
      }
      {
        jError = mkErrorPanel();
        getContentPane().add(jError, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(20, 10, 10, 20), 0, 0));
//        jError.setHorizontalAlignment(SwingConstants.CENTER);
//        jError.setHorizontalTextPosition(SwingConstants.CENTER);
      }
      {
        jPanel1 = new JPanel();
        getContentPane().add(jPanel1, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        {
  ...
  private void jDetailsActionPerformed(ActionEvent evt) {
    if(jDetails.isSelected()) {
      getContentPane().add(jScrollPane, new GridBagConstraints(0, 2, 2, 1, 0.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(10, 10, 10, 10), 0, 0));
...
//      jTextArea.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
  ...
  public static void showExceptionDialog(Window parentComponent, Throwable throwable) {
  ...
  public static void main(String[] args) {
    ...
    showExceptionDialog(new JFrame(), "ugly looooooooooong error with lots of details, for instance http://java.sun.com/j2se/1.4.2/docs/api/java/awt/GridBagLayout.html#columnWidths");
    showExceptionDialog(new JFrame(), "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
    showExceptionDialog(new JFrame(), "1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890");
    System.exit(0);
  }
  ...
  public static void showExceptionDialog(Window parentComponent, String message, Throwable throwable) {
    ExceptionDialog dlg = new ExceptionDialog(parentComponent, throwable);
