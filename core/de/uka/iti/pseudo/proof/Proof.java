...
public class Proof extends Observable {
     ...
     * 
     * After the invokation, the proofNode returns <code>null</code> from
    ...
    /**
     * inform all subsribed oversevers that a proof node has changed.
     * 
     * <p>
    ...
    /**
     * upon each invokation of this method return a new integer.
     * 
     ...
     * rules, be sure to have aquired this lock beforehand.
     * 
