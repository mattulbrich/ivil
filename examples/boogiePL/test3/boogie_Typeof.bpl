...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Typeof
...
implementation Typeof.M(this: ref)
{
  ...
  block2941:
    // ----- load token  ----- Typeof.ssc(3,16)
    havoc stack0s;
    assume $IsTokenForType(stack0s, Typeof);
    // ----- statically resolved GetTypeFromHandle call  ----- Typeof.ssc(3,5)
    t := TypeObject(Typeof);
    goto block2958;

  block2958:
    // ----- serialized AssertStatement  ----- Typeof.ssc(4,5)
    assert t != null;
    goto block3111;
  ...
  block3128:
    // ----- serialized AssertStatement  ----- Typeof.ssc(5,5)
    assert $IsNotNull(t, System.Type);
    goto block3281;
  ...
  block3298:
    // ----- serialized AssertStatement  ----- Typeof.ssc(6,5)
...
implementation Typeof.N(this: ref)
{
  ...
  block4029:
    // ----- load token  ----- Typeof.ssc(9,16)
    havoc stack0s;
    assume $IsTokenForType(stack0s, Typeof);
    // ----- statically resolved GetTypeFromHandle call  ----- Typeof.ssc(9,5)
    t := TypeObject(Typeof);
    goto block4046;

  block4046:
    // ----- serialized AssertStatement  ----- Typeof.ssc(10,5)
    assert $IsNotNull(t, System.String);
    goto block4199;
...
implementation Typeof..ctor(this: ref)
{
  ...
  block4505:
    ...
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Typeof ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Typeof;
    assume IsHeap($Heap);
    return;
